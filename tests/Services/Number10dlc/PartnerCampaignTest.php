...
final class PartnerCampaignTest extends TestCase
{
    ...
    #[Test]
    public function testRetrieveSharedByMe(): void
    {
        if (UnsupportedMockTests::$skip) {
            $this->markTestSkipped('Prism tests are disabled');
        }

        $result = $this->client->number10dlc->partnerCampaign->retrieveSharedByMe();
    ...
    public function testRetrieveSharing(): void
    {
        ...
        $result = $this->client->number10dlc->partnerCampaign->retrieveSharing(
            'campaignId'
        );
