...
final class PhoneNumbersTest extends TestCase
{
    ...
    #[Test]
    public function testGetConversationWindow(): void
    {
        if (UnsupportedMockTests::$skip) {
            $this->markTestSkipped('Mock server tests are disabled');
        }

        $result = $this->client->whatsapp->phoneNumbers->getConversationWindow(
            'phone_number',
    ...
    #[Test]
    public function testGetConversationWindowWithOptionalParams(): void
    {
        if (UnsupportedMockTests::$skip) {
            $this->markTestSkipped('Mock server tests are disabled');
        }
