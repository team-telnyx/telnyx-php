...
namespace Tests\Services\EmailUnsubscribeGroups;
...
final class SuppressionsTest extends TestCase
{
    ...
    public function testList(): void
    {
        ...
        $page = $this->client->emailUnsubscribeGroups->suppressions->list(
            '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e'
        );
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->emailUnsubscribeGroups->suppressions->delete(
            'email',
