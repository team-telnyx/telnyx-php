 ...
 */
#[CoversNothing]
final class GlobalIPHealthChecksTest extends TestCase
{
    ...
    public function testRetrieve(): void
    {
        ...
        $result = $this->client->globalIPHealthChecks->retrieve(
    ...
    public function testList(): void
    {
        ...
        if ($item = $page->getItems()[0] ?? null) {
            // @phpstan-ignore-next-line method.alreadyNarrowedType
            $this->assertInstanceOf(GlobalIPHealthCheck::class, $item);
        }
    }
    ...
    public function testDelete(): void
    {
        ...
        $result = $this->client->globalIPHealthChecks->delete(
            '6a09cdc3-8948-47f0-aa62-74ac943d6c58'
        );
