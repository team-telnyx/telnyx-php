...
use Telnyx\SimCards\Actions\WirelessSimCardAction\ActionType;
use Telnyx\SimCards\Actions\WirelessSimCardAction\Status;

/**
 * This object represents a SIM card action. It allows tracking the current status of an operation that impacts the SIM card.
 *
 * @phpstan-import-type StatusShape from \Telnyx\SimCards\Actions\WirelessSimCardAction\Status
 *
 * @phpstan-type WirelessSimCardActionShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class WirelessSimCardAction implements BaseModel
{
    /** @use SdkModel<WirelessSimCardActionShape> */
    use SdkModel;
