 ...
 *
 * @phpstan-type ActionEnableVoiceResponseShape = array{
 *   data?: null|WirelessSimCardAction|WirelessSimCardActionShape
 * }
 */
final class ActionEnableVoiceResponse implements BaseModel
{
    /** @use SdkModel<ActionEnableVoiceResponseShape> */
    use SdkModel;
