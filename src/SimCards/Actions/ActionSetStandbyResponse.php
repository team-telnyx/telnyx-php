...
/**
 * @phpstan-type action_set_standby_response = array{data?: SimCardAction}
 */
final class ActionSetStandbyResponse implements BaseModel, ResponseConverter
{
    /** @use SdkModel<action_set_standby_response> */
    use SdkModel;
