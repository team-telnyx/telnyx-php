 ...
 *
 * @phpstan-type ActionDisableVoiceResponseShape = array{
 *   data?: null|WirelessSimCardAction|WirelessSimCardActionShape
 * }
 */
final class ActionDisableVoiceResponse implements BaseModel
{
    /** @use SdkModel<ActionDisableVoiceResponseShape> */
    use SdkModel;
