 ...
 * Example usage:
 * ```
 * $params = (new BillingBundleListParams); // set properties as needed
 * $client->bundlePricing.billingBundles->list(...$params->toArray());
 * ```
