...
use Telnyx\DefaultFlatPagination\Meta;

/**
 * @phpstan-type DefaultFlatPaginationShape = array{
 ...
 */
final class DefaultFlatPagination implements BaseModel, BasePage
{
    /** @use SdkModel<DefaultFlatPaginationShape> */
    use SdkModel;
