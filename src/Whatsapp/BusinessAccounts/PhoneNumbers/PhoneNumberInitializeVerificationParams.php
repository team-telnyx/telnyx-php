 ...
 *
 * @phpstan-type PhoneNumberInitializeVerificationParamsShape = array{
 *   displayName: string,
 *   phoneNumber: string,
 ...
 * }
 */
final class PhoneNumberInitializeVerificationParams implements BaseModel
{
    /** @use SdkModel<PhoneNumberInitializeVerificationParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new PhoneNumberInitializeVerificationParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PhoneNumberInitializeVerificationParams::with(
     ...
     *
     * ```
     * (new PhoneNumberInitializeVerificationParams)
     *   ->withDisplayName(...)
     *   ->withPhoneNumber(...)
     * ```
     */
