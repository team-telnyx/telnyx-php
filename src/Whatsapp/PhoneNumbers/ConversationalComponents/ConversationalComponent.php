...
use Telnyx\Whatsapp\PhoneNumbers\ConversationalComponents\ConversationalComponent\Command;

/**
 * @phpstan-import-type CommandShape from \Telnyx\Whatsapp\PhoneNumbers\ConversationalComponents\ConversationalComponent\Command
 *
 * @phpstan-type ConversationalComponentShape = array{
 ...
 * }
 */
final class ConversationalComponent implements BaseModel
{
    /** @use SdkModel<ConversationalComponentShape> */
    use SdkModel;
