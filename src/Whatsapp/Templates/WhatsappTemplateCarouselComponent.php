...
use Telnyx\Whatsapp\Templates\WhatsappTemplateCarouselComponent\Card;
use Telnyx\Whatsapp\Templates\WhatsappTemplateCarouselComponent\Type;

/**
 * Carousel component for multi-card templates. Each card can contain its own header, body, and buttons.
 *
 * @phpstan-import-type CardShape from \Telnyx\Whatsapp\Templates\WhatsappTemplateCarouselComponent\Card
 *
