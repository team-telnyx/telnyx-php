...
use Telnyx\AdvancedOrders\AdvancedOrderRequest\Feature;
use Telnyx\AdvancedOrders\AdvancedOrderRequest\PhoneNumberType;
use Telnyx\Core\Attributes\Optional;
use Telnyx\Core\Concerns\SdkModel;
use Telnyx\Core\Contracts\BaseModel;

/**
 * @phpstan-type AdvancedOrderRequestShape = array{
 ...
 * }
 */
final class AdvancedOrderRequest implements BaseModel
{
    /** @use SdkModel<AdvancedOrderRequestShape> */
    use SdkModel;
