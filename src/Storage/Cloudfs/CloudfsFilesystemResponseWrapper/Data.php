...
final class Data implements BaseModel
{
    ...
    /**
     * PostgreSQL connection URL for the filesystem's metadata database, including the metadata token as the password. Pass it to `juicefs mount`: the storage configuration is baked in at provisioning, so the metadata URL is all a client needs to mount the filesystem.
     */
    #[Optional('meta_url')]
