 ...
 *
 * @see Telnyx\Services\Storage\Kvs\KeysService::update()
 *
 * @phpstan-type KeyUpdateParamsShape = array{id: string, ttlSecs?: int|null}
 */
final class KeyUpdateParams implements BaseModel
{
    /** @use SdkModel<KeyUpdateParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new KeyUpdateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * KeyUpdateParams::with(id: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new KeyUpdateParams)->withID(...)
     * ```
     */
