...
use Telnyx\Storage\Kvs\KvListResponse\Status;

/**
 * @phpstan-type KvListResponseShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class KvListResponse implements BaseModel
{
    /** @use SdkModel<KvListResponseShape> */
    use SdkModel;
