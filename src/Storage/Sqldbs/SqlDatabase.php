...
use Telnyx\Storage\Sqldbs\SqlDatabase\Status;

/**
 * @phpstan-type SqlDatabaseShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class SqlDatabase implements BaseModel
{
    /** @use SdkModel<SqlDatabaseShape> */
    use SdkModel;
