...
use Telnyx\InfringementClaims\InfringementClaim\Dir;
use Telnyx\InfringementClaims\InfringementClaim\Resolution;
use Telnyx\InfringementClaims\InfringementClaim\Status;

/**
 * @phpstan-import-type DocumentShape from \Telnyx\Dir\Document
 * @phpstan-import-type ContestHistoryShape from \Telnyx\InfringementClaims\InfringementClaim\ContestHistory
 * @phpstan-import-type DirShape from \Telnyx\InfringementClaims\InfringementClaim\Dir
 *
 * @phpstan-type InfringementClaimShape = array{
 *   id?: string|null,
 ...
 *   contestDocuments?: list<Document|DocumentShape>|null,
 ...
 * }
 */
final class InfringementClaim implements BaseModel
{
    /** @use SdkModel<InfringementClaimShape> */
    use SdkModel;
     ...
     *
     * @var list<Document>|null $contestDocuments
     */
    #[Optional('contest_documents', list: Document::class)]
     ...
     * Aggregated across all customer contest submissions on this claim.
     *
     * @param list<Document|DocumentShape> $contestDocuments
     */
