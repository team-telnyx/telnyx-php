...
use Telnyx\PortingOrders\PhoneNumberBlocks\PhoneNumberBlockListParams\Filter\Status\PortingOrderStatusArray;

/**
 * Filter porting orders by status(es). Originally: filter[status], filter[status][in][].
 *
 * @phpstan-type StatusVariants = list<value-of<PortingOrderStatusArray>>|value-of<PortingOrderSingleStatus>
...
final class Status implements ConverterSource
{
    ...
    {
        return [
            PortingOrderSingleStatus::class,
            new ListOf(PortingOrderStatusArray::class),
        ];
    }
}
