...
/**
 * @phpstan-type PortingPhoneNumberConfigurationShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class PortingPhoneNumberConfiguration implements BaseModel
{
    /** @use SdkModel<PortingPhoneNumberConfigurationShape> */
    use SdkModel;
