...
use Telnyx\PortingOrders\Comments\PortingOrdersComment\UserType;

/**
 * @phpstan-type PortingOrdersCommentShape = array{
 *   id?: string|null,
 *   body?: string|null,
 ...
 * }
 */
final class PortingOrdersComment implements BaseModel
{
    /** @use SdkModel<PortingOrdersCommentShape> */
    use SdkModel;
