...
use Telnyx\PortingOrders\AdditionalDocuments\PortingAdditionalDocument\DocumentType;

/**
 * @phpstan-type PortingAdditionalDocumentShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class PortingAdditionalDocument implements BaseModel
{
    /** @use SdkModel<PortingAdditionalDocumentShape> */
    use SdkModel;
