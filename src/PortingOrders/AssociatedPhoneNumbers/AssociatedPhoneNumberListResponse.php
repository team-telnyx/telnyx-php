...
/**
 * @phpstan-type associated_phone_number_list_response = array{
...
{
    /** @use SdkModel<associated_phone_number_list_response> */
    use SdkModel;
     ...
     *
     * @param list<PortingAssociatedPhoneNumber> $data
     */
