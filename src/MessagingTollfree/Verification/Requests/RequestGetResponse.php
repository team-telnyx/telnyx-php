 ...
 *
 * @phpstan-type RequestGetResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class RequestGetResponse implements BaseModel
{
    /** @use SdkModel<RequestGetResponseShape> */
    use SdkModel;
    ...
    /**
     * `new RequestGetResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * RequestGetResponse::with(
     *   id: ...,
