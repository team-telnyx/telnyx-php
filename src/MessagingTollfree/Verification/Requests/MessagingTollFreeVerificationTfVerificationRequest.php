 ...
 *
 * @phpstan-type MessagingTollFreeVerificationTfVerificationRequestShape = array{
 ...
 * }
 */
final class MessagingTollFreeVerificationTfVerificationRequest implements BaseModel
{
    /** @use SdkModel<MessagingTollFreeVerificationTfVerificationRequestShape> */
    use SdkModel;
    ...
    /**
     * `new MessagingTollFreeVerificationTfVerificationRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MessagingTollFreeVerificationTfVerificationRequest::with(
     ...
     *
     * ```
     * (new MessagingTollFreeVerificationTfVerificationRequest)
     ...
     * @param Omitted|MessagingTollFreeVerificationEntityType|value-of<MessagingTollFreeVerificationEntityType>|null $entityType
     */
