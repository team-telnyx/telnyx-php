 ...
 *
 * @phpstan-type MessagingTollFreeVerificationVerificationRequestEgressShape = array{
 *   id: string,
 ...
 * }
 */
final class MessagingTollFreeVerificationVerificationRequestEgress implements BaseModel
{
    /** @use SdkModel<MessagingTollFreeVerificationVerificationRequestEgressShape> */
    use SdkModel;
     ...
     */
    #[Optional(enum: MessagingTollFreeVerificationEntityType::class)]
    ...
    /**
     * `new MessagingTollFreeVerificationVerificationRequestEgress()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MessagingTollFreeVerificationVerificationRequestEgress::with(
     *   id: ...,
     ...
     *
     * ```
     * (new MessagingTollFreeVerificationVerificationRequestEgress)
     *   ->withID(...)
    ...
    public static function with(
        ...
        $self['verificationRequestID'] = $verificationRequestID;
     ...
     * Business entity classification.
     *
     * @param MessagingTollFreeVerificationEntityType|value-of<MessagingTollFreeVerificationEntityType> $entityType
     */
    public function withEntityType(
        MessagingTollFreeVerificationEntityType|string $entityType
    ): self {
        $self = clone $this;
