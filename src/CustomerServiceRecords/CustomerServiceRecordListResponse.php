...
/**
 * @phpstan-type customer_service_record_list_response = array{
 *   data?: list<CustomerServiceRecord>, meta?: PaginationMeta
 * }
...
{
    /** @use SdkModel<customer_service_record_list_response> */
    use SdkModel;
     ...
     *
     * @param list<CustomerServiceRecord> $data
     */
