...
use Telnyx\UacConnections\UacInbound\AniNumberFormat;
use Telnyx\UacConnections\UacInbound\DefaultRoutingMethod;
use Telnyx\UacConnections\UacInbound\DnisNumberFormat;
use Telnyx\UacConnections\UacInbound\SimultaneousRinging;
use Telnyx\UacConnections\UacInbound\SipRegion;
use Telnyx\UacConnections\UacInbound\SipSubdomainReceiveSettings;

/**
 * @phpstan-type UacInboundShape = array{
 ...
 * }
 */
final class UacInbound implements BaseModel
{
    /** @use SdkModel<UacInboundShape> */
    use SdkModel;
