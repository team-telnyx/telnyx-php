 ...
 *
 * @phpstan-type UacInternalSettingsShape = array{destinationUri?: string|null}
 */
final class UacInternalSettings implements BaseModel
{
    /** @use SdkModel<UacInternalSettingsShape> */
    use SdkModel;
