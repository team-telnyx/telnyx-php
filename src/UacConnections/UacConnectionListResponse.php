...
use Telnyx\UacConnections\UacConnectionListResponse\Authentication;
use Telnyx\UacConnections\UacConnectionListResponse\ExternalUacSettings;
use Telnyx\UacConnections\UacConnectionListResponse\FqdnOutboundAuthentication;
use Telnyx\UacConnections\UacConnectionListResponse\Inbound;
use Telnyx\UacConnections\UacConnectionListResponse\InternalUacSettings;
use Telnyx\UacConnections\UacConnectionListResponse\NoiseSuppression;
use Telnyx\UacConnections\UacConnectionListResponse\Outbound;
use Telnyx\UacConnections\UacConnectionListResponse\SipUriCallingPreference;
use Telnyx\UacConnections\UacConnectionListResponse\WebhookAPIVersion;
 ...
 *
 * @phpstan-import-type ExternalUacSettingsShape from \Telnyx\UacConnections\UacConnectionListResponse\ExternalUacSettings
 * @phpstan-import-type FqdnShape from \Telnyx\Fqdns\Fqdn
 * @phpstan-import-type InboundShape from \Telnyx\UacConnections\UacConnectionListResponse\Inbound
 * @phpstan-import-type InternalUacSettingsShape from \Telnyx\UacConnections\UacConnectionListResponse\InternalUacSettings
 ...
 * @phpstan-import-type OutboundShape from \Telnyx\UacConnections\UacConnectionListResponse\Outbound
 * @phpstan-import-type ConnectionRtcpSettingsShape from \Telnyx\CredentialConnections\ConnectionRtcpSettings
 *
 * @phpstan-type UacConnectionListResponseShape = array{
 *   id?: string|null,
 *   active?: bool|null,
 ...
 * }
 */
final class UacConnectionListResponse implements BaseModel
{
    /** @use SdkModel<UacConnectionListResponseShape> */
    use SdkModel;
