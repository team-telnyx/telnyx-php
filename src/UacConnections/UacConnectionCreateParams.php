 ...
 *
 * @see Telnyx\Services\UacConnectionsService::create()
 *
 * @phpstan-import-type UacExternalSettingsShape from \Telnyx\UacConnections\UacExternalSettings
 * @phpstan-import-type UacInboundRequestShape from \Telnyx\UacConnections\UacInboundRequest
 ...
 *
 * @phpstan-type UacConnectionCreateParamsShape = array{
 ...
 *   inbound?: null|UacInboundRequest|UacInboundRequestShape,
 ...
 * }
 */
final class UacConnectionCreateParams implements BaseModel
{
    /** @use SdkModel<UacConnectionCreateParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new UacConnectionCreateParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * UacConnectionCreateParams::with(connectionName: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new UacConnectionCreateParams)->withConnectionName(...)
     * ```
     */
     ...
     * Inbound settings that can be supplied when creating or updating a UAC connection. The SIP subdomain fields returned in UAC connection responses are generated by Telnyx and are not accepted as request parameters.
     *
     * @param UacInboundRequest|UacInboundRequestShape $inbound
     */
    public function withInbound(UacInboundRequest|array $inbound): self
    {
        $self = clone $this;
