...
use Telnyx\UacConnections\UacOutbound\AniOverrideType;
use Telnyx\UacConnections\UacOutbound\T38ReinviteSource;

/**
 * @phpstan-type UacOutboundShape = array{
 ...
 * }
 */
final class UacOutbound implements BaseModel
{
    /** @use SdkModel<UacOutboundShape> */
    use SdkModel;
