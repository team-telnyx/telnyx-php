 ...
 *
 * @see Telnyx\Services\UacConnectionsService::list()
 *
 * @phpstan-import-type FilterShape from \Telnyx\UacConnections\UacConnectionListParams\Filter
 *
 * @phpstan-type UacConnectionListParamsShape = array{
 ...
 * }
 */
final class UacConnectionListParams implements BaseModel
{
    /** @use SdkModel<UacConnectionListParamsShape> */
    use SdkModel;
    use SdkParams;
