...
use Telnyx\UacConnections\UacConnectionUpdateParams\ExternalUacSettings;
use Telnyx\UacConnections\UacConnectionUpdateParams\Inbound;
use Telnyx\UacConnections\UacConnectionUpdateParams\InternalUacSettings;
use Telnyx\UacConnections\UacConnectionUpdateParams\NoiseSuppression;
use Telnyx\UacConnections\UacConnectionUpdateParams\Outbound;
use Telnyx\UacConnections\UacConnectionUpdateParams\SipUriCallingPreference;
use Telnyx\UacConnections\UacConnectionUpdateParams\WebhookAPIVersion;

/**
 * Updates settings of an existing UAC connection.
 *
 * @see Telnyx\Services\UacConnectionsService::update()
 *
 * @phpstan-import-type ExternalUacSettingsShape from \Telnyx\UacConnections\UacConnectionUpdateParams\ExternalUacSettings
 * @phpstan-import-type InboundShape from \Telnyx\UacConnections\UacConnectionUpdateParams\Inbound
 * @phpstan-import-type InternalUacSettingsShape from \Telnyx\UacConnections\UacConnectionUpdateParams\InternalUacSettings
 ...
 * @phpstan-import-type OutboundShape from \Telnyx\UacConnections\UacConnectionUpdateParams\Outbound
 * @phpstan-import-type ConnectionRtcpSettingsShape from \Telnyx\CredentialConnections\ConnectionRtcpSettings
 *
 * @phpstan-type UacConnectionUpdateParamsShape = array{
 *   active?: bool|null,
 ...
 * }
 */
final class UacConnectionUpdateParams implements BaseModel
{
    /** @use SdkModel<UacConnectionUpdateParamsShape> */
    use SdkModel;
    use SdkParams;
