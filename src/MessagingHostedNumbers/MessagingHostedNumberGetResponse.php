 ...
 *
 * @phpstan-type MessagingHostedNumberGetResponseShape = array{
 *   data?: null|PhoneNumberWithMessagingSettings|PhoneNumberWithMessagingSettingsShape,
 * }
 */
final class MessagingHostedNumberGetResponse implements BaseModel
{
    /** @use SdkModel<MessagingHostedNumberGetResponseShape> */
    use SdkModel;
