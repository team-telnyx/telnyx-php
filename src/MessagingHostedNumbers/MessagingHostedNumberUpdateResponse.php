 ...
 *
 * @phpstan-type MessagingHostedNumberUpdateResponseShape = array{
 *   data?: null|PhoneNumberWithMessagingSettings|PhoneNumberWithMessagingSettingsShape,
 * }
 */
final class MessagingHostedNumberUpdateResponse implements BaseModel
{
    /** @use SdkModel<MessagingHostedNumberUpdateResponseShape> */
    use SdkModel;
