 ...
 *
 * @phpstan-type ActionAddAIAssistantMessagesResponseShape = array{
 *   data?: null|CallControlCommandResult|CallControlCommandResultShape
 * }
 */
final class ActionAddAIAssistantMessagesResponse implements BaseModel
{
    /** @use SdkModel<ActionAddAIAssistantMessagesResponseShape> */
    use SdkModel;
