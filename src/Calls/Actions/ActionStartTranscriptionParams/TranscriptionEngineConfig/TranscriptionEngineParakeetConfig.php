...
use Telnyx\Calls\Actions\ActionStartTranscriptionParams\TranscriptionEngineConfig\TranscriptionEngineParakeetConfig\TranscriptionEngine;
use Telnyx\Calls\Actions\ActionStartTranscriptionParams\TranscriptionEngineConfig\TranscriptionEngineParakeetConfig\TranscriptionModel;
use Telnyx\Core\Attributes\Optional;
use Telnyx\Core\Concerns\SdkModel;
use Telnyx\Core\Contracts\BaseModel;

/**
 * @phpstan-type TranscriptionEngineParakeetConfigShape = array{
 ...
 * }
 */
final class TranscriptionEngineParakeetConfig implements BaseModel
{
    /** @use SdkModel<TranscriptionEngineParakeetConfigShape> */
    use SdkModel;
