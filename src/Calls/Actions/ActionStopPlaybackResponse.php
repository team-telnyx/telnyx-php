...
/**
 * @phpstan-type action_stop_playback_response = array{
 *   data?: CallControlCommandResult
 * }
 */
final class ActionStopPlaybackResponse implements BaseModel, ResponseConverter
{
    /** @use SdkModel<action_stop_playback_response> */
    use SdkModel;
