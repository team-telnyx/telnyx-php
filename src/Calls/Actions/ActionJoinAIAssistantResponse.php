 ...
 *
 * @phpstan-type ActionJoinAIAssistantResponseShape = array{
 *   data?: null|CallControlCommandResultWithConversationID|CallControlCommandResultWithConversationIDShape,
 * }
 */
final class ActionJoinAIAssistantResponse implements BaseModel
{
    /** @use SdkModel<ActionJoinAIAssistantResponseShape> */
    use SdkModel;
