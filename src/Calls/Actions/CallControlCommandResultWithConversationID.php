...
/**
 * @phpstan-type CallControlCommandResultWithConversationIDShape = array{
 *   conversationID?: string|null, result?: string|null
 * }
 */
final class CallControlCommandResultWithConversationID implements BaseModel
{
    /** @use SdkModel<CallControlCommandResultWithConversationIDShape> */
    use SdkModel;
