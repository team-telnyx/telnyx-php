 ...
 *
 * @phpstan-type ActionStopConversationRelayResponseShape = array{
 *   data?: null|CallControlCommandResult|CallControlCommandResultShape
 * }
 */
final class ActionStopConversationRelayResponse implements BaseModel
{
    /** @use SdkModel<ActionStopConversationRelayResponseShape> */
    use SdkModel;
