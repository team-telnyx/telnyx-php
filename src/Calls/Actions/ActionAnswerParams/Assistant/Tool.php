...
namespace Telnyx\Calls\Actions\ActionAnswerParams\Assistant;

use Telnyx\AI\Assistants\HangupTool;
use Telnyx\AI\Assistants\TransferTool;
use Telnyx\AI\Assistants\WebhookTool;
use Telnyx\Calls\Actions\ActionAnswerParams\Assistant\Tool\BookAppointmentTool;
use Telnyx\Calls\Actions\ActionAnswerParams\Assistant\Tool\CallControlRetrievalTool;
use Telnyx\Calls\Actions\ActionAnswerParams\Assistant\Tool\CheckAvailabilityTool;
use Telnyx\Core\Concerns\SdkUnion;
use Telnyx\Core\Conversion\Contracts\Converter;
use Telnyx\Core\Conversion\Contracts\ConverterSource;

/**
 * @phpstan-import-type BookAppointmentToolShape from \Telnyx\Calls\Actions\ActionAnswerParams\Assistant\Tool\BookAppointmentTool
 * @phpstan-import-type CheckAvailabilityToolShape from \Telnyx\Calls\Actions\ActionAnswerParams\Assistant\Tool\CheckAvailabilityTool
 ...
 * @phpstan-import-type CallControlRetrievalToolShape from \Telnyx\Calls\Actions\ActionAnswerParams\Assistant\Tool\CallControlRetrievalTool
 *
