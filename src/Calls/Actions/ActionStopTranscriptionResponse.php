...
/**
 * @phpstan-type action_stop_transcription_response = array{
 ...
 * @mixin TRawResponse
 */
final class ActionStopTranscriptionResponse implements BaseModel
{
    /** @use SdkModel<action_stop_transcription_response> */
    use SdkModel;
