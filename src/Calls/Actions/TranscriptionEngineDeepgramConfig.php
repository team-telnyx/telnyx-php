...
use Telnyx\Calls\Actions\TranscriptionEngineDeepgramConfig\Language;
use Telnyx\Calls\Actions\TranscriptionEngineDeepgramConfig\TranscriptionEngine;
use Telnyx\Calls\Actions\TranscriptionEngineDeepgramConfig\TranscriptionModel;
use Telnyx\Core\Attributes\Api;
use Telnyx\Core\Concerns\SdkModel;
use Telnyx\Core\Contracts\BaseModel;

/**
 * @phpstan-type TranscriptionEngineDeepgramConfigShape = array{
...
{
    /** @use SdkModel<TranscriptionEngineDeepgramConfigShape> */
    use SdkModel;
    ...
    /**
     * `new TranscriptionEngineDeepgramConfig()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * TranscriptionEngineDeepgramConfig::with(
     ...
     *
     * ```
     * (new TranscriptionEngineDeepgramConfig)
