...
use Telnyx\Calls\Actions\TranscriptionEngineGoogleConfig\TranscriptionEngine;
 ...
 * }
 */
final class TranscriptionEngineGoogleConfig implements BaseModel
{
    /** @use SdkModel<TranscriptionEngineGoogleConfigShape> */
    use SdkModel;
