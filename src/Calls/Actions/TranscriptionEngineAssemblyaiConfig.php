...
use Telnyx\Calls\Actions\TranscriptionEngineAssemblyaiConfig\TranscriptionEngine;
use Telnyx\Calls\Actions\TranscriptionEngineAssemblyaiConfig\TranscriptionModel;
