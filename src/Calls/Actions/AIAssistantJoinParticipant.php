...
use Telnyx\Calls\Actions\AIAssistantJoinParticipant\OnHangup;
use Telnyx\Calls\Actions\AIAssistantJoinParticipant\Role;
...
/**
 * @phpstan-type AIAssistantJoinParticipantShape = array{
 *   id: string,
 ...
 * }
 */
final class AIAssistantJoinParticipant implements BaseModel
{
    /** @use SdkModel<AIAssistantJoinParticipantShape> */
    use SdkModel;
    ...
    /**
     * `new AIAssistantJoinParticipant()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AIAssistantJoinParticipant::with(id: ..., role: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AIAssistantJoinParticipant)->withID(...)->withRole(...)
     * ```
     */
