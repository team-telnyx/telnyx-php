...
/**
 * @phpstan-type action_start_noise_suppression_response = array{
 ...
 * @mixin TRawResponse
 */
final class ActionStartNoiseSuppressionResponse implements BaseModel
{
    /** @use SdkModel<action_start_noise_suppression_response> */
    use SdkModel;
