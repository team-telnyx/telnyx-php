...
use Telnyx\Calls\ConversationRelayEmbeddedConfig\TranscriptionEngine;
use Telnyx\Calls\ConversationRelayEmbeddedConfig\VoiceSettings;
 ...
 *
 * @phpstan-import-type VoiceSettingsVariants from \Telnyx\Calls\ConversationRelayEmbeddedConfig\VoiceSettings
 ...
 * @phpstan-import-type VoiceSettingsShape from \Telnyx\Calls\ConversationRelayEmbeddedConfig\VoiceSettings
 *
 * @phpstan-type ConversationRelayEmbeddedConfigShape = array{
 *   url: string,
 ...
 * }
 */
final class ConversationRelayEmbeddedConfig implements BaseModel
{
    /** @use SdkModel<ConversationRelayEmbeddedConfigShape> */
    use SdkModel;
    ...
    /**
     * `new ConversationRelayEmbeddedConfig()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ConversationRelayEmbeddedConfig::with(url: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ConversationRelayEmbeddedConfig)->withURL(...)
     * ```
     */
