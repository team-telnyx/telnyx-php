 ...
 *
 * @phpstan-type PhoneNumberBatchShape = array{
 *   batchID?: string|null,
 *   dirDisplayName?: string|null,
 *   dirID?: string|null,
 *   documents?: list<Document|DocumentShape>|null,
 *   enterpriseID?: string|null,
 *   phoneNumbers?: list<DirPhoneNumber|DirPhoneNumberShape>|null,
 *   status?: null|DirPhoneNumberStatus|value-of<DirPhoneNumberStatus>,
 *   submittedAt?: \DateTimeInterface|null,
 *   totalCount?: int|null,
 * }
 */
final class PhoneNumberBatch implements BaseModel
{
    /** @use SdkModel<PhoneNumberBatchShape> */
    use SdkModel;
     ...
     *
     * @var list<DirPhoneNumber>|null $phoneNumbers
     */
    #[Optional('phone_numbers', list: DirPhoneNumber::class)]
     ...
     * @param list<DirPhoneNumber|DirPhoneNumberShape>|null $phoneNumbers
     ...
     * All phone numbers in this batch, with per-number status.
     *
     * @param list<DirPhoneNumber|DirPhoneNumberShape> $phoneNumbers
     */
