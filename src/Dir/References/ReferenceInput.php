 ...
 *
 * @phpstan-type ReferenceInputShape = array{
 *   email: string,
 *   fullName: string,
 *   phoneE164: string,
 *   timezone: string,
 ...
 * }
 */
final class ReferenceInput implements BaseModel
{
    /** @use SdkModel<ReferenceInputShape> */
    use SdkModel;
    ...
    /**
     * `new ReferenceInput()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ReferenceInput::with(email: ..., fullName: ..., phoneE164: ..., timezone: ...)
     * ```
     *
