 ...
 *
 * @phpstan-type FinancialReferenceShape = array{
 *   email: string,
 *   fullName: string,
 *   phoneE164: string,
 *   timezone: string,
 ...
 * }
 */
final class FinancialReference implements BaseModel
{
    /** @use SdkModel<FinancialReferenceShape> */
    use SdkModel;
    ...
    /**
     * `new FinancialReference()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * FinancialReference::with(
