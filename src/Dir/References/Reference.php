 ...
 *
 * @phpstan-type ReferenceShape = array{
 *   fullName: string,
 *   phoneE164: string,
 ...
 * }
 */
final class Reference implements BaseModel
{
    /** @use SdkModel<ReferenceShape> */
    use SdkModel;
    ...
    /**
     * `new Reference()` is missing required properties by the API.
     *
