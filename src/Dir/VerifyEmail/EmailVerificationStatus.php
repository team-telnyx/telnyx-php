 ...
 *
 * @phpstan-type EmailVerificationStatusShape = array{
 *   emailVerified: bool,
 ...
 * }
 */
final class EmailVerificationStatus implements BaseModel
{
    /** @use SdkModel<EmailVerificationStatusShape> */
    use SdkModel;
    ...
    /**
     * `new EmailVerificationStatus()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * EmailVerificationStatus::with(emailVerified: ..., recordType: ..., status: ...)
     * ```
     *
