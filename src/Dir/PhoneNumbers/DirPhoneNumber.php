...
/**
 * @phpstan-import-type RejectionReasonShape from \Telnyx\Dir\PhoneNumbers\RejectionReason
 *
 * @phpstan-type DirPhoneNumberShape = array{
 *   id?: string|null,
 *   batchID?: string|null,
 ...
 * }
 */
final class DirPhoneNumber implements BaseModel
{
    /** @use SdkModel<DirPhoneNumberShape> */
    use SdkModel;
