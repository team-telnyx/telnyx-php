...
/**
 * @phpstan-type AvailablePhoneNumbersMetadataShape = array{
 *   bestEffortResults?: int|null, totalResults?: int|null
 * }
 */
final class AvailablePhoneNumbersMetadata implements BaseModel
{
    /** @use SdkModel<AvailablePhoneNumbersMetadataShape> */
    use SdkModel;
