...
use Telnyx\Porting\Events\EventGetResponse\Data\PortingEventWithoutWebhook\AvailableNotificationMethod;
use Telnyx\Porting\Events\EventGetResponse\Data\PortingEventWithoutWebhook\EventType;
use Telnyx\Porting\Events\EventGetResponse\Data\PortingEventWithoutWebhook\PayloadStatus;
 ...
 * }
 */
final class PortingEventWithoutWebhook implements BaseModel
{
    /** @use SdkModel<PortingEventWithoutWebhookShape> */
    use SdkModel;
    ...
    /**
     * @param null|null $payload
     */
    public function withPayload(null $payload): self
    {
        $self = clone $this;
        $self['payload'] = $payload;
