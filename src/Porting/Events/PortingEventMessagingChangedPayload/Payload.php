...
use Telnyx\Porting\Events\PortingEventMessagingChangedPayload\Payload\Messaging;

/**
 * The webhook payload for the porting_order.messaging_changed event.
 *
 * @phpstan-import-type MessagingShape from \Telnyx\Porting\Events\PortingEventMessagingChangedPayload\Payload\Messaging
 *
