...
use Telnyx\Porting\Events\PortingEventNewCommentEvent\Payload\Comment;

/**
 * The webhook payload for the porting_order.new_comment event.
 *
 * @phpstan-import-type CommentShape from \Telnyx\Porting\Events\PortingEventNewCommentEvent\Payload\Comment
 *
