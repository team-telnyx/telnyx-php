...
use Telnyx\Porting\Events\PortingEventSplitEvent\Payload\From;
use Telnyx\Porting\Events\PortingEventSplitEvent\Payload\PortingPhoneNumber;
use Telnyx\Porting\Events\PortingEventSplitEvent\Payload\To;

/**
 * The webhook payload for the porting_order.split event.
 *
 * @phpstan-import-type FromShape from \Telnyx\Porting\Events\PortingEventSplitEvent\Payload\From
 * @phpstan-import-type PortingPhoneNumberShape from \Telnyx\Porting\Events\PortingEventSplitEvent\Payload\PortingPhoneNumber
 * @phpstan-import-type ToShape from \Telnyx\Porting\Events\PortingEventSplitEvent\Payload\To
 *
