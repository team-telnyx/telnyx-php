...
use Telnyx\EmailValidations\EmailValidationChecks\Typo;

/**
 * @phpstan-import-type EmailValidationCheckShape from \Telnyx\EmailValidations\EmailValidationCheck
 * @phpstan-import-type TypoShape from \Telnyx\EmailValidations\EmailValidationChecks\Typo
 *
 * @phpstan-type EmailValidationChecksShape = array{
 ...
 * }
 */
final class EmailValidationChecks implements BaseModel
{
    /** @use SdkModel<EmailValidationChecksShape> */
    use SdkModel;
    ...
    /**
     * `new EmailValidationChecks()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * EmailValidationChecks::with(
     *   disposable: ..., mx: ..., roleBased: ..., syntax: ..., typo: ...
     * )
     * ```
     *
