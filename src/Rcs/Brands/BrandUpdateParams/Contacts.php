...
namespace Telnyx\Rcs\Brands\BrandUpdateParams;

use Telnyx\Core\Attributes\Required;
use Telnyx\Core\Concerns\SdkModel;
use Telnyx\Core\Contracts\BaseModel;
use Telnyx\Rcs\Brands\BrandUpdateParams\Contacts\Brand;

/**
 * Named business contacts. Use the `brand` key for the required BRAND contact.
 *
 * @phpstan-import-type BrandShape from \Telnyx\Rcs\Brands\BrandUpdateParams\Contacts\Brand
 *
