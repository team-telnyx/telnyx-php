...
/**
 * @phpstan-type TexmlRecordingTranscriptionShape = array{
 ...
 * }
 */
final class TexmlRecordingTranscription implements BaseModel
{
    /** @use SdkModel<TexmlRecordingTranscriptionShape> */
    use SdkModel;
