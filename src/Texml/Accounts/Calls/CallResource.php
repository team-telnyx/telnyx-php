...
use Telnyx\Texml\Accounts\Calls\CallResource\AnsweredBy;
use Telnyx\Texml\Accounts\Calls\CallResource\Direction;
use Telnyx\Texml\Accounts\Calls\CallResource\Status;

/**
 * @phpstan-type CallResourceShape = array{
 ...
 * }
 */
final class CallResource implements BaseModel
{
    /** @use SdkModel<CallResourceShape> */
    use SdkModel;
