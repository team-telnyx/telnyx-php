 ...
 *
 * @phpstan-type TexmlGetCallRecordingsResponseBodyShape = array{
 *   end?: int|null,
 ...
 * }
 */
final class TexmlGetCallRecordingsResponseBody implements BaseModel
{
    /** @use SdkModel<TexmlGetCallRecordingsResponseBodyShape> */
    use SdkModel;
