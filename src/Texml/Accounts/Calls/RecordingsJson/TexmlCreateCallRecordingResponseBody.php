...
/**
 * @phpstan-type TexmlCreateCallRecordingResponseBodyShape = array{
 ...
 * }
 */
final class TexmlCreateCallRecordingResponseBody implements BaseModel
{
    /** @use SdkModel<TexmlCreateCallRecordingResponseBodyShape> */
    use SdkModel;
