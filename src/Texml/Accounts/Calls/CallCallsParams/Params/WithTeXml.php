...
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\AsyncAmdStatusCallbackMethod;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\CustomHeader;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\DeepfakeDetection;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\DeepfakeDetectionCallbackMethod;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\DetectionMode;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\MachineDetection;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\MediaEncryption;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\RecordingChannels;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\RecordingStatusCallbackMethod;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\RecordingTrack;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\SipRegion;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\StatusCallbackEvent;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\StatusCallbackMethod;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\SupervisingRole;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\Trim;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\URLMethod;

/**
 * @phpstan-import-type CustomHeaderShape from \Telnyx\Texml\Accounts\Calls\CallCallsParams\Params\WithTeXml\CustomHeader
 *
 * @phpstan-type WithTeXmlShape = array{
 *   texml: string,
 ...
 * }
 */
final class WithTeXml implements BaseModel
{
    /** @use SdkModel<WithTeXmlShape> */
    use SdkModel;
    ...
    /**
     * `new WithTeXml()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * WithTeXml::with(texml: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new WithTeXml)->withTexml(...)
     * ```
     */
