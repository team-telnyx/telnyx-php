...
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\DeepfakeDetectionCallbackMethod;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\DetectionMode;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\MachineDetection;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\MachineDetectionBeepProfile;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\MediaEncryption;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\RecordingChannels;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\RecordingStatusCallbackMethod;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\RecordingTrack;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\SipRegion;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\StatusCallbackMethod;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\SupervisingRole;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\Trim;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\URLMethod;

/**
 * @phpstan-import-type CustomHeaderShape from \Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithTeXml\CustomHeader
 *
