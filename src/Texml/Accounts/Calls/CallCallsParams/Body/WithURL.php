...
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\DeepfakeDetectionCallbackMethod;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\DetectionMode;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\MachineDetection;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\MachineDetectionBeepProfile;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\MediaEncryption;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\RecordingChannels;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\RecordingStatusCallbackMethod;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\RecordingTrack;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\SipRegion;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\StatusCallbackMethod;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\SupervisingRole;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\Trim;
use Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\URLMethod;

/**
 * @phpstan-import-type CustomHeaderShape from \Telnyx\Texml\Accounts\Calls\CallCallsParams\Body\WithURL\CustomHeader
 *
 * @phpstan-type WithURLShape = array{
 *   url: string,
 ...
 * }
 */
final class WithURL implements BaseModel
{
    /** @use SdkModel<WithURLShape> */
    use SdkModel;
    ...
    /**
     * `new WithURL()` is missing required properties by the API.
     *
