...
use Telnyx\Texml\Accounts\Conferences\ConferenceResource\ReasonConferenceEnded;
use Telnyx\Texml\Accounts\Conferences\ConferenceResource\Status;

/**
 * @phpstan-type ConferenceResourceShape = array{
 ...
 * }
 */
final class ConferenceResource implements BaseModel
{
    /** @use SdkModel<ConferenceResourceShape> */
    use SdkModel;
