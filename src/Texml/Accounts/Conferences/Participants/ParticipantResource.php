...
use Telnyx\Texml\Accounts\Conferences\Participants\ParticipantResource\Status;

/**
 * @phpstan-type ParticipantResourceShape = array{
 ...
 * }
 */
final class ParticipantResource implements BaseModel
{
    /** @use SdkModel<ParticipantResourceShape> */
    use SdkModel;
