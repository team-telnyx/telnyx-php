 ...
 *
 * @phpstan-type EmailBlockImportShape = array{
 *   id: string,
 ...
 * }
 */
final class EmailBlockImport implements BaseModel
{
    /** @use SdkModel<EmailBlockImportShape> */
    use SdkModel;
    ...
    /**
     * `new EmailBlockImport()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * EmailBlockImport::with(
     *   id: ...,
     *   createdAt: ...,
     *   recordType: ...,
     *   status: ...,
