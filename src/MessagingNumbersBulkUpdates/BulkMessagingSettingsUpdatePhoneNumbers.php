...
use Telnyx\MessagingNumbersBulkUpdates\BulkMessagingSettingsUpdatePhoneNumbers\RecordType;

/**
 * @phpstan-type BulkMessagingSettingsUpdatePhoneNumbersShape = array{
 ...
 * }
 */
final class BulkMessagingSettingsUpdatePhoneNumbers implements BaseModel
{
    /** @use SdkModel<BulkMessagingSettingsUpdatePhoneNumbersShape> */
    use SdkModel;
