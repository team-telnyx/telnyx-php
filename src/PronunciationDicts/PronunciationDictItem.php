 ...
 *
 * @phpstan-type PronunciationDictItemVariants = PronunciationDictAliasItem|PronunciationDictPhonemeItem
 * @phpstan-type PronunciationDictItemShape = PronunciationDictItemVariants|PronunciationDictAliasItemShape|PronunciationDictPhonemeItemShape
 */
final class PronunciationDictItem implements ConverterSource
{
    use SdkUnion;
