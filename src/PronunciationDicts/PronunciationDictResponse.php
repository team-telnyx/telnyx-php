 ...
 *
 * @phpstan-type PronunciationDictResponseShape = array{
 *   data?: null|PronunciationDictData|PronunciationDictDataShape
 * }
 */
final class PronunciationDictResponse implements BaseModel
{
    /** @use SdkModel<PronunciationDictResponseShape> */
    use SdkModel;
