...
final class CallsService implements CallsContract
{
     ...
     * @param 'GET'|'POST'|FallbackMethod $fallbackMethod HTTP request type used for `FallbackUrl`
     ...
     * @param 'GET'|'POST'|Method $method HTTP request type used for `Url`
     ...
     * @param 'GET'|'POST'|StatusCallbackMethod $statusCallbackMethod HTTP request type used for `StatusCallback`
     ...
     * @param 'GET'|'POST'|\Telnyx\Texml\Calls\CallInitiateParams\StatusCallbackMethod $statusCallbackMethod HTTP request type used for `StatusCallback`
    ...
    public function initiate(
        ...
        string|\Telnyx\Texml\Calls\CallInitiateParams\StatusCallbackMethod $statusCallbackMethod = 'POST',
