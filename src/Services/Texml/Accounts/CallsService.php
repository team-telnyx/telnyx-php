...
final class CallsService implements CallsContract
{
     ...
     * @param DeepfakeDetection|value-of<DeepfakeDetection> $deepfakeDetection Enables Deepfake Detection on the dialed call. When enabled, audio from the remote party is analyzed to determine whether the voice is AI-generated. Results are delivered asynchronously via a callback.
     * @param DeepfakeDetectionCallbackMethod|value-of<DeepfakeDetectionCallbackMethod> $deepfakeDetectionCallbackMethod HTTP request type used for `DeepfakeDetectionCallbackUrl`
     * @param string $deepfakeDetectionCallbackURL URL destination for Telnyx to send deepfake detection callback events to for the call
    ...
    public function calls(
        ...
        DeepfakeDetectionCallbackMethod|string $deepfakeDetectionCallbackMethod = 'POST',
        ...
        $params = Util::removeNulls(
            [
                ...
                'deepfakeDetectionCallbackURL' => $deepfakeDetectionCallbackURL,
