...
final class ParticipantsService implements ParticipantsContract
{
     ...
     * @param 'GET'|'POST'|HoldMethod $holdMethod body param: The HTTP method to use when calling the `HoldUrl`
    ...
    public function update(
        ...
        ?bool $hold = null,
        string|HoldMethod|null $holdMethod = null,
        ?string $holdURL = null,
        ?bool $muted = null,
        ?string $waitURL = null,
        ?RequestOptions $requestOptions = null,
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->update($callSidOrParticipantLabel, params: $params, requestOptions: $requestOptions);
     ...
     * @param 'GET'|'POST'|AmdStatusCallbackMethod $amdStatusCallbackMethod Body param: HTTP request type used for `AmdStatusCallback`. Defaults to `POST`.
     * @param 'true'|'false'|'onEnter'|'onExit'|Beep $beep body param: Whether to play a notification beep to the conference when the participant enters and exits
     ...
     * @param bool $coaching Body param: Whether the participant is coaching another call. When `true`, `CallSidToCoach` has to be given.
     * @param 'true'|'false'|'record-from-start'|'do-not-record'|ConferenceRecord $conferenceRecord Body param: Whether to record the conference the participant is joining. Defualts to `do-not-record`. The boolean values `true` and `false` are synonymous with `record-from-start` and `do-not-record` respectively.
     ...
     * @param 'GET'|'POST'|ConferenceRecordingStatusCallbackMethod $conferenceRecordingStatusCallbackMethod Body param: HTTP request type used for `ConferenceRecordingStatusCallback`. Defaults to `POST`.
     ...
     * @param 'GET'|'POST'|ConferenceStatusCallbackMethod $conferenceStatusCallbackMethod Body param: HTTP request type used for `ConferenceStatusCallback`. Defaults to `POST`.
     * @param 'trim-silence'|'do-not-trim'|ConferenceTrim $conferenceTrim Body param: Whether to trim any leading and trailing silence from the conference recording. Defaults to `trim-silence`.
     * @param list<array{
     *   name: string, value: string
     * }> $customHeaders Body param: Custom HTTP headers to be sent with the call. Each header should be an object with 'name' and 'value' properties.
     ...
     * @param 'mono'|'dual'|RecordingChannels $recordingChannels Body param: The number of channels in the final recording. Defaults to `mono`.
     ...
     * @param 'GET'|'POST'|RecordingStatusCallbackMethod $recordingStatusCallbackMethod Body param: HTTP request type used for `RecordingStatusCallback`. Defaults to `POST`.
     ...
     * @param 'trim-silence'|'do-not-trim'|Trim $trim Body param: Whether to trim any leading and trailing silence from the recording. Defaults to `trim-silence`.
     * @param string $waitURL body param: The URL to call for an audio file to play while the participant is waiting for the conference to start
     *
     * @throws APIException
     */
    public function participants(
        ...
        string|AmdStatusCallbackMethod|null $amdStatusCallbackMethod = null,
        string|Beep|null $beep = null,
        ?string $callerID = null,
        ?string $callSidToCoach = null,
        bool $cancelPlaybackOnDetectMessageEnd = true,
        bool $cancelPlaybackOnMachineDetection = true,
        ?bool $coaching = null,
        string|ConferenceRecord|null $conferenceRecord = null,
        ?string $conferenceRecordingStatusCallback = null,
        ?string $conferenceRecordingStatusCallbackEvent = null,
        string|ConferenceRecordingStatusCallbackMethod|null $conferenceRecordingStatusCallbackMethod = null,
        int $conferenceRecordingTimeout = 0,
        ?string $conferenceStatusCallback = null,
        ?string $conferenceStatusCallbackEvent = null,
        string|ConferenceStatusCallbackMethod|null $conferenceStatusCallbackMethod = null,
        string|ConferenceTrim|null $conferenceTrim = null,
        ?array $customHeaders = null,
        bool $earlyMedia = false,
        ?bool $endConferenceOnExit = null,
        ?string $from = null,
        string|MachineDetection|null $machineDetection = null,
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->participants($conferenceSid, params: $params, requestOptions: $requestOptions);
