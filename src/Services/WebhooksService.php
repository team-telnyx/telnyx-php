...
use Telnyx\Lib\WebhookVerification;
use Telnyx\ServiceContracts\WebhooksContract;
use Telnyx\Webhooks\ArtifactCompletedWebhookEvent;
use Telnyx\Webhooks\ArtifactFailedWebhookEvent;
...
use Telnyx\Webhooks\CallCostWebhookEvent;
use Telnyx\Webhooks\CallDeepfakeDetectionErrorWebhookEvent;
use Telnyx\Webhooks\CallDeepfakeDetectionResultWebhookEvent;
...
use Telnyx\Webhooks\CallHoldWebhookEvent;
...
use Telnyx\Webhooks\CallPaymentCompletedWebhookEvent;
use Telnyx\Webhooks\CallPaymentProgressWebhookEvent;
...
use Telnyx\Webhooks\CallUnholdWebhookEvent;
...
use Telnyx\Webhooks\HostedNumberOrderEventWebhookEvent;
use Telnyx\Webhooks\InboundMessageWebhookEvent;
use Telnyx\Webhooks\NumberOrderStatusUpdateWebhookEvent;
use Telnyx\Webhooks\RecordingAvailableWebhookEvent;
use Telnyx\Webhooks\ReplacedLinkClickWebhookEvent;
use Telnyx\Webhooks\SessionStatusChangedWebhookEvent;
use Telnyx\Webhooks\TranscriptCompletedWebhookEvent;
...
use Telnyx\Webhooks\WhatsappAccountUpdate;
use Telnyx\Webhooks\WhatsappMessageEcho;

final class WebhooksService implements WebhooksContract
{
    // Use the WebhookVerification trait for ED25519 signature verification.
    // This trait provides verify() and doVerifySignature() methods.
    use WebhookVerification;
