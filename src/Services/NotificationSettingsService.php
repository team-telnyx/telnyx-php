...
final class NotificationSettingsService implements NotificationSettingsContract
{
    ...
    public function create(
        ...
        $params = array_filter(
            [
                'notificationChannelID' => $notificationChannelID ?? Omitted::VALUE,
                'notificationEventConditionID' => $notificationEventConditionID ?? Omitted::VALUE,
                'notificationProfileID' => $notificationProfileID ?? Omitted::VALUE,
