...
final class UacConnectionsService implements UacConnectionsContract
{
     ...
     * @param UacExternalSettings|UacExternalSettingsShape $externalUacSettings external SIP peer settings used by Telnyx when registering to your PBX and routing outbound calls
     ...
     * @param UacInternalSettings|UacInternalSettingsShape $internalUacSettings internal Telnyx-side settings for a UAC connection
     ...
     * @param RequestOpts|null $requestOptions
     *
     * @return DefaultFlatPagination<UacConnection>
     *
     * @throws APIException
     */
