...
final class UacConnectionsService implements UacConnectionsContract
{
     ...
     * @param UacInboundRequest|UacInboundRequestShape $inbound Inbound settings that can be supplied when creating or updating a UAC connection. The SIP subdomain fields returned in UAC connection responses are generated by Telnyx and are not accepted as request parameters.
    ...
    public function create(
        ...
        $params = array_filter(
            [
                ...
                'externalUacSettings' => $externalUacSettings ?? Omitted::VALUE,
                'inbound' => $inbound ?? Omitted::VALUE,
                'internalUacSettings' => $internalUacSettings ?? Omitted::VALUE,
