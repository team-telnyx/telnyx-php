...
final class PhoneNumberAssignmentByProfileRawService implements PhoneNumberAssignmentByProfileRawContract
{
     ...
     * }|PhoneNumberAssignmentByProfileGetPhoneNumberStatusParams $params
     *
    ...
    public function getPhoneNumberStatus(
        ...
        [$parsed, $options] = PhoneNumberAssignmentByProfileGetPhoneNumberStatusParams::parseRequest(
            $params,
            $requestOptions,
        );
    ...
    public function getTaskStatus(
        ...
        return $this->client->request(
            ...
            convert: PhoneNumberAssignmentByProfileGetTaskStatusResponse::class,
        );
    }
}
