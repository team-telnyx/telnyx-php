...
final class PhoneNumberAssignmentByProfileService implements PhoneNumberAssignmentByProfileContract
{
    ...
    public function getPhoneNumberStatus(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->getPhoneNumberStatus($taskID, params: $params, requestOptions: $requestOptions);
    ...
    public function getTaskStatus(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->getTaskStatus($taskID, requestOptions: $requestOptions);
