...
use Telnyx\ServiceContracts\Number10dlc\PhoneNumberAssignmentByProfileContract;
...
final class PhoneNumberAssignmentByProfileService implements PhoneNumberAssignmentByProfileContract
{
    ...
    ): PhoneNumberAssignmentByProfileGetResponse {
    ...
    public function phoneNumberAssignmentByProfile(
        ...
        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->phoneNumberAssignmentByProfile(params: $params, requestOptions: $requestOptions);
    ...
    public function retrievePhoneNumbers(
        ...
        ?RequestOptions $requestOptions = null,
    ): PhoneNumberAssignmentByProfileGetPhoneNumbersResponse {
        $params = Util::removeNulls(
            ['page' => $page, 'recordsPerPage' => $recordsPerPage]
        );

        // @phpstan-ignore-next-line argument.type
        $response = $this->raw->retrievePhoneNumbers($taskID, params: $params, requestOptions: $requestOptions);
