...
use Telnyx\AI\Missions\MissionListResponse\ExecutionMode;
...
/**
 * @phpstan-type MissionListResponseShape = array{
 ...
 * }
 */
final class MissionListResponse implements BaseModel
{
    /** @use SdkModel<MissionListResponseShape> */
    use SdkModel;
    ...
    /**
     * `new MissionListResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MissionListResponse::with(
