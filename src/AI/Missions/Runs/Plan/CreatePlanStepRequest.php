...
/**
 * @phpstan-type CreatePlanStepRequestShape = array{
 *   description: string,
 *   sequence: int,
 *   stepID: string,
 ...
 * }
 */
final class CreatePlanStepRequest implements BaseModel
{
    /** @use SdkModel<CreatePlanStepRequestShape> */
    use SdkModel;
    ...
    /**
     * `new CreatePlanStepRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CreatePlanStepRequest::with(description: ..., sequence: ..., stepID: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CreatePlanStepRequest)
     *   ->withDescription(...)
     *   ->withSequence(...)
     *   ->withStepID(...)
     * ```
