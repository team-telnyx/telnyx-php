 ...
 *
 * @phpstan-type MissionRunResponseShape = array{
 *   data: MissionRunData|MissionRunDataShape
 * }
 */
final class MissionRunResponse implements BaseModel
{
    /** @use SdkModel<MissionRunResponseShape> */
    use SdkModel;
    ...
    /**
     * `new MissionRunResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MissionRunResponse::with(data: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new MissionRunResponse)->withData(...)
     * ```
     */
