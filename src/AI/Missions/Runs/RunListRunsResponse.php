...
use Telnyx\AI\Missions\Runs\RunListRunsResponse\Status;
...
/**
 * @phpstan-type RunListRunsResponseShape = array{
 *   missionID: string,
 *   runID: string,
 ...
 * }
 */
final class RunListRunsResponse implements BaseModel
{
    /** @use SdkModel<RunListRunsResponseShape> */
    use SdkModel;
    ...
    /**
     * `new RunListRunsResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * RunListRunsResponse::with(
