 ...
 *
 * @phpstan-type EventResponseShape = array{data: EventData|EventDataShape}
 */
final class EventResponse implements BaseModel
{
    /** @use SdkModel<EventResponseShape> */
    use SdkModel;
    ...
    /**
     * `new EventResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * EventResponse::with(data: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new EventResponse)->withData(...)
     * ```
     */
