...
namespace Telnyx\AI\Missions\Runs\TelnyxAgents\TelnyxAgentLinkResponse;
...
final class Data implements BaseModel
{
     ...
     * ```
     * Data::with(createdAt: ..., runID: ..., telnyxAgentID: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new Data)->withCreatedAt(...)->withRunID(...)->withTelnyxAgentID(...)
     * ```
     */
