 ...
 *
 * @phpstan-type AIRetrieveConversationHistoriesParamsShape = array{
 *   q: string,
 ...
 * }
 */
final class AIRetrieveConversationHistoriesParams implements BaseModel
{
    /** @use SdkModel<AIRetrieveConversationHistoriesParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new AIRetrieveConversationHistoriesParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AIRetrieveConversationHistoriesParams::with(q: ..., recordType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AIRetrieveConversationHistoriesParams)->withQ(...)->withRecordType(...)
     * ```
     */
