...
/**
 * @phpstan-type McpServerGetResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class McpServerGetResponse implements BaseModel, ResponseConverter
{
    /** @use SdkModel<McpServerGetResponseShape> */
    use SdkModel;
    ...
    /**
     * `new McpServerGetResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * McpServerGetResponse::with(
