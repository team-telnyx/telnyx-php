 ...
 *
 * @phpstan-type AssistantMcpServerShape = array{
 *   id: string, allowedTools?: list<string>|null
 * }
 */
final class AssistantMcpServer implements BaseModel
{
    /** @use SdkModel<AssistantMcpServerShape> */
    use SdkModel;
    ...
    /**
     * `new AssistantMcpServer()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AssistantMcpServer::with(id: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AssistantMcpServer)->withID(...)
     * ```
     */
