...
namespace Telnyx\AI\Assistants\ScheduledEvents\ScheduledEventCreateParams;

use Telnyx\AI\Assistants\ScheduledEvents\ScheduledEventCreateParams\CallSettings\SipRegion;
 ...
 *
 * @phpstan-type CallSettingsShape = array{
 *   sipRegion?: null|SipRegion|value-of<SipRegion>
 * }
 */
final class CallSettings implements BaseModel
{
    /** @use SdkModel<CallSettingsShape> */
    use SdkModel;
