 ...
 *
 * @phpstan-type RuleInputShape = array{
 *   serve: Serve|ServeShape, match?: list<Clause|ClauseShape>|null
 * }
 */
final class RuleInput implements BaseModel
{
    /** @use SdkModel<RuleInputShape> */
    use SdkModel;
    ...
    /**
     * `new RuleInput()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * RuleInput::with(serve: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new RuleInput)->withServe(...)
     * ```
     */
