...
namespace Telnyx\AI\Assistants\Versions\VersionUpdateParams\FallbackConfig;

use Telnyx\AI\Assistants\Versions\VersionUpdateParams\FallbackConfig\ExternalLlm\AuthenticationMethod;
