 ...
 * Example usage:
 * ```
 * $params = (new AssistantUpdateParams); // set properties as needed
 * $client->ai.assistants->update(...$params->toArray());
 * ```
 ...
 *
 * @phpstan-type assistant_update_params = array{
 *   description?: string,
...
{
    /** @use SdkModel<assistant_update_params> */
    use SdkModel;
    use SdkParams;
     ...
     */
    #[Api('promote_to_main', optional: true)]
