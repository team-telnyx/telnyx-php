...
namespace Telnyx\AI\Assistants\AssistantCreateParams\FallbackConfig;

use Telnyx\AI\Assistants\AssistantCreateParams\FallbackConfig\ExternalLlm\AuthenticationMethod;
