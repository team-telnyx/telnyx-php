...
/**
 * @phpstan-type assistant_new_response = array{
 *   id: string,
 ...
 * }
 */
final class AssistantNewResponse implements BaseModel, ResponseConverter
{
    /** @use SdkModel<assistant_new_response> */
    use SdkModel;
    ...
    /**
     * `new AssistantNewResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AssistantNewResponse::with(
