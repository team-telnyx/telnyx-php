...
namespace Telnyx\AI\Assistants\InferenceEmbedding\FallbackConfig;

use Telnyx\AI\Assistants\InferenceEmbedding\FallbackConfig\ExternalLlm\AuthenticationMethod;
