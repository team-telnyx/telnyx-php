...
namespace Telnyx\AI\Assistants\InferenceEmbedding\WidgetSettings;

use Telnyx\AI\Assistants\InferenceEmbedding\WidgetSettings\AudioVisualizerConfig\Color;
