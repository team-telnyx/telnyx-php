...
/**
 * @phpstan-type assistant_clone_response = array{
 *   id: string,
 ...
 * }
 */
final class AssistantCloneResponse implements BaseModel, ResponseConverter
{
    /** @use SdkModel<assistant_clone_response> */
    use SdkModel;
    ...
    /**
     * `new AssistantCloneResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AssistantCloneResponse::with(
