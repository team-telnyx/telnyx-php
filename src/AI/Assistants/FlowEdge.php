...
use Telnyx\AI\Assistants\FlowEdge\Condition;
...
use Telnyx\AI\Assistants\FlowEdge\Target;
use Telnyx\AI\Assistants\FlowEdge\Target\AssistantTarget;
use Telnyx\AI\Assistants\FlowEdge\Target\NodeTarget;
 ...
 * @phpstan-import-type ConditionShape from \Telnyx\AI\Assistants\FlowEdge\Condition
 * @phpstan-import-type TargetShape from \Telnyx\AI\Assistants\FlowEdge\Target
 *
 * @phpstan-type FlowEdgeShape = array{
 *   id: string,
 ...
 * }
 */
final class FlowEdge implements BaseModel
{
    /** @use SdkModel<FlowEdgeShape> */
    use SdkModel;
    ...
    /**
     * `new FlowEdge()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * FlowEdge::with(id: ..., condition: ..., startNodeID: ..., target: ...)
     * ```
     *
