...
/**
 * @phpstan-type IntegrationConnectionShape = array{
 *   id: string, allowedTools: list<string>, integrationID: string
 * }
 */
final class IntegrationConnection implements BaseModel
{
    /** @use SdkModel<IntegrationConnectionShape> */
    use SdkModel;
    ...
    /**
     * `new IntegrationConnection()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * IntegrationConnection::with(id: ..., allowedTools: ..., integrationID: ...)
     * ```
     *
