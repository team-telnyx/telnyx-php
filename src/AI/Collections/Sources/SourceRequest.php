...
/**
 * @phpstan-type SourceRequestShape = array{
 *   sourceType: SourceType|value-of<SourceType>, bucketID?: string|null
 * }
 */
final class SourceRequest implements BaseModel
{
    /** @use SdkModel<SourceRequestShape> */
    use SdkModel;
    ...
    /**
     * `new SourceRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SourceRequest::with(sourceType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SourceRequest)->withSourceType(...)
     * ```
     */
