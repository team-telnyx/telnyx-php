...
/**
 * @phpstan-type ToolListResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class ToolListResponse implements BaseModel
{
    /** @use SdkModel<ToolListResponseShape> */
    use SdkModel;
    ...
    /**
     * `new ToolListResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ToolListResponse::with(id: ..., toolDefinition: ..., type: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ToolListResponse)->withID(...)->withToolDefinition(...)->withType(...)
     * ```
     */
