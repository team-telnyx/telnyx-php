...
/**
 * @phpstan-type SharedToolResponseShape = array{
 *   id: string,
 ...
 * }
 */
final class SharedToolResponse implements BaseModel
{
    /** @use SdkModel<SharedToolResponseShape> */
    use SdkModel;
    ...
    /**
     * `new SharedToolResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SharedToolResponse::with(id: ..., toolDefinition: ..., type: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SharedToolResponse)->withID(...)->withToolDefinition(...)->withType(...)
     * ```
     */
