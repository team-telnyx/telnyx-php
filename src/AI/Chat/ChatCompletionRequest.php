...
use Telnyx\AI\Chat\ChatCompletionRequest\ToolChoice;
...
/**
 * @phpstan-import-type StopVariants from \Telnyx\AI\Chat\ChatCompletionRequest\Stop
 * @phpstan-import-type ToolVariants from \Telnyx\AI\Chat\ChatCompletionRequest\Tool
 * @phpstan-import-type MessageShape from \Telnyx\AI\Chat\ChatCompletionRequest\Message
 * @phpstan-import-type ResponseFormatShape from \Telnyx\AI\Chat\ChatCompletionRequest\ResponseFormat
 * @phpstan-import-type StopShape from \Telnyx\AI\Chat\ChatCompletionRequest\Stop
 * @phpstan-import-type ToolShape from \Telnyx\AI\Chat\ChatCompletionRequest\Tool
 *
 * @phpstan-type ChatCompletionRequestShape = array{
 ...
 * }
 */
final class ChatCompletionRequest implements BaseModel
{
    /** @use SdkModel<ChatCompletionRequestShape> */
    use SdkModel;
    ...
    /**
     * `new ChatCompletionRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ChatCompletionRequest::with(messages: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ChatCompletionRequest)->withMessages(...)
     * ```
     */
