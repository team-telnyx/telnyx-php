...
namespace Telnyx\AI\OpenAI\Chat\ChatCreateCompletionParams\Message\Content;

use Telnyx\AI\OpenAI\Chat\ChatCreateCompletionParams\Message\Content\TextAndImageArray\Type;
