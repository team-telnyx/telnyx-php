...
use Telnyx\AI\OpenAI\Embeddings\EmbeddingCreateEmbeddingsParams\Input;
 ...
 *
 * @see Telnyx\Services\AI\OpenAI\EmbeddingsService::createEmbeddings()
 *
 * @phpstan-import-type InputVariants from \Telnyx\AI\OpenAI\Embeddings\EmbeddingCreateEmbeddingsParams\Input
 * @phpstan-import-type InputShape from \Telnyx\AI\OpenAI\Embeddings\EmbeddingCreateEmbeddingsParams\Input
 *
 * @phpstan-type EmbeddingCreateEmbeddingsParamsShape = array{
 *   input: InputShape,
 *   model: string,
 *   dimensions?: int|null,
 ...
 * }
 */
final class EmbeddingCreateEmbeddingsParams implements BaseModel
{
    /** @use SdkModel<EmbeddingCreateEmbeddingsParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new EmbeddingCreateEmbeddingsParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * EmbeddingCreateEmbeddingsParams::with(input: ..., model: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new EmbeddingCreateEmbeddingsParams)->withInput(...)->withModel(...)
     * ```
     */
