 ...
 * ```
 *
 * @see Telnyx\Services\AIService::listConversationHistories()
 *
 * @phpstan-type AIListConversationHistoriesParamsShape = array{
 *   q: string,
 ...
 * }
 */
final class AIListConversationHistoriesParams implements BaseModel
{
    /** @use SdkModel<AIListConversationHistoriesParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new AIListConversationHistoriesParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * AIListConversationHistoriesParams::with(q: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new AIListConversationHistoriesParams)->withQ(...)
     * ```
     */
