...
use Telnyx\ChannelZones\GcbChannelZone\RecordType;
...
/**
 * @phpstan-type GcbChannelZoneShape = array{
 *   id: string,
 *   channels: int,
 ...
 * }
 */
final class GcbChannelZone implements BaseModel
{
    /** @use SdkModel<GcbChannelZoneShape> */
    use SdkModel;
    ...
    /**
     * `new GcbChannelZone()` is missing required properties by the API.
     *
