...
use Telnyx\Messages\MessageSendLongCodeParams\Encoding;
...
final class MessageSendLongCodeParams implements BaseModel
{
    ...
    /**
     * `new MessageSendLongCodeParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MessageSendLongCodeParams::with(from: ..., to: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new MessageSendLongCodeParams)->withFrom(...)->withTo(...)
     * ```
     */
