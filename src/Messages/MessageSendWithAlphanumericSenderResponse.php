 ...
 *
 * @phpstan-type MessageSendWithAlphanumericSenderResponseShape = array{
 *   data?: null|OutboundMessagePayload|OutboundMessagePayloadShape
 * }
 */
final class MessageSendWithAlphanumericSenderResponse implements BaseModel
{
    /** @use SdkModel<MessageSendWithAlphanumericSenderResponseShape> */
    use SdkModel;
