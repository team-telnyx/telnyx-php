...
use Telnyx\Messages\WhatsappContact\Address;
use Telnyx\Messages\WhatsappContact\Email;
use Telnyx\Messages\WhatsappContact\Org;
use Telnyx\Messages\WhatsappContact\Phone;
use Telnyx\Messages\WhatsappContact\URL;

/**
 * @phpstan-import-type AddressShape from \Telnyx\Messages\WhatsappContact\Address
 * @phpstan-import-type EmailShape from \Telnyx\Messages\WhatsappContact\Email
 * @phpstan-import-type OrgShape from \Telnyx\Messages\WhatsappContact\Org
 * @phpstan-import-type PhoneShape from \Telnyx\Messages\WhatsappContact\Phone
 * @phpstan-import-type URLShape from \Telnyx\Messages\WhatsappContact\URL
 *
 * @phpstan-type WhatsappContactShape = array{
 ...
 * }
 */
final class WhatsappContact implements BaseModel
{
    /** @use SdkModel<WhatsappContactShape> */
    use SdkModel;
