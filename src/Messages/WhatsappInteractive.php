...
use Telnyx\Messages\WhatsappInteractive\Action;
use Telnyx\Messages\WhatsappInteractive\Body;
use Telnyx\Messages\WhatsappInteractive\Footer;
use Telnyx\Messages\WhatsappInteractive\Header;
use Telnyx\Messages\WhatsappInteractive\Type;

/**
 * @phpstan-import-type ActionShape from \Telnyx\Messages\WhatsappInteractive\Action
 * @phpstan-import-type BodyShape from \Telnyx\Messages\WhatsappInteractive\Body
 * @phpstan-import-type FooterShape from \Telnyx\Messages\WhatsappInteractive\Footer
 * @phpstan-import-type HeaderShape from \Telnyx\Messages\WhatsappInteractive\Header
 *
 * @phpstan-type WhatsappInteractiveShape = array{
 ...
 * }
 */
final class WhatsappInteractive implements BaseModel
{
    /** @use SdkModel<WhatsappInteractiveShape> */
    use SdkModel;
