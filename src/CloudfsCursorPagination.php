...
use Telnyx\CloudfsCursorPagination\Meta;
...
/**
 * @phpstan-type CloudfsCursorPaginationShape = array{
 ...
 */
final class CloudfsCursorPagination implements BaseModel, BasePage
{
    /** @use SdkModel<CloudfsCursorPaginationShape> */
    use SdkModel;
    ...
    public function nextRequest(): ?array
    {
        ...
        if (!($next = $this->meta->cursors->after ?? null)) {
            return null;
        }
