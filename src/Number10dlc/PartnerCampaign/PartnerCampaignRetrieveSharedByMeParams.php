 ...
 *
 * @see Telnyx\Services\Number10dlc\PartnerCampaignService::retrieveSharedByMe()
 *
 * @phpstan-type PartnerCampaignRetrieveSharedByMeParamsShape = array{
 *   page?: int, recordsPerPage?: int
 * }
 */
final class PartnerCampaignRetrieveSharedByMeParams implements BaseModel
{
    /** @use SdkModel<PartnerCampaignRetrieveSharedByMeParamsShape> */
    use SdkModel;
    use SdkParams;
