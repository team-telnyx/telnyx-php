 ...
 *
 * @see Telnyx\Services\Number10dlc\PartnerCampaignService::getSharedByMe()
 *
 * @phpstan-type PartnerCampaignGetSharedByMeParamsShape = array{
 *   page?: int, recordsPerPage?: int
 * }
 */
final class PartnerCampaignGetSharedByMeParams implements BaseModel
{
    /** @use SdkModel<PartnerCampaignGetSharedByMeParamsShape> */
    use SdkModel;
    use SdkParams;
