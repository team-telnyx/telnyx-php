...
namespace Telnyx\Number10dlc\CampaignBuilder;
 ...
 *
 * @see Telnyx\Services\Number10dlc\CampaignBuilderService::campaignBuilder()
 *
 * @phpstan-type CampaignBuilderCampaignBuilderParamsShape = array{
 *   brandID: string,
 *   description: string,
 *   usecase: string,
 *   ageGated?: bool,
 ...
 * }
 */
final class CampaignBuilderCampaignBuilderParams implements BaseModel
{
    /** @use SdkModel<CampaignBuilderCampaignBuilderParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new CampaignBuilderCampaignBuilderParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CampaignBuilderCampaignBuilderParams::with(
     *   brandID: ..., description: ..., usecase: ...
     * )
     * ```
     *
     ...
     *
     * ```
     * (new CampaignBuilderCampaignBuilderParams)
     *   ->withBrandID(...)
     *   ->withDescription(...)
     *   ->withUsecase(...)
     * ```
