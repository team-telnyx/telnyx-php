...
/**
 * @phpstan-type CampaignGetSharingResponseShape = array{
 *   sharedByMe?: CampaignSharingStatus|null,
 *   sharedWithMe?: CampaignSharingStatus|null,
 * }
 */
final class CampaignGetSharingResponse implements BaseModel
{
    /** @use SdkModel<CampaignGetSharingResponseShape> */
    use SdkModel;
