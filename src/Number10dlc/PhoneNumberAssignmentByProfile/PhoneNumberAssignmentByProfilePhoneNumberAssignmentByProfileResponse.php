...
/**
 * @phpstan-type PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileResponseShape = array{
 ...
 * }
 */
final class PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileResponse implements BaseModel
{
    /**
     * @use SdkModel<PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileResponseShape>
     */
    use SdkModel;
    ...
    /**
     * `new PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileResponse::with(
     ...
     *
     * ```
     * (new PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileResponse)
