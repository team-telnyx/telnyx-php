 ...
 *
 * @see Telnyx\Services\Number10dlc\PhoneNumberAssignmentByProfileService::phoneNumberAssignmentByProfile()
 *
 * @phpstan-type PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParamsShape = array{
 *   messagingProfileID: string, campaignID?: string, tcrCampaignID?: string
 * }
 */
final class PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams implements BaseModel
{
    /**
     * @use SdkModel<PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParamsShape,>
     */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams::with(
     *   messagingProfileID: ...
     * )
     * ```
     *
     ...
     *
     * ```
     * (new PhoneNumberAssignmentByProfilePhoneNumberAssignmentByProfileParams)
