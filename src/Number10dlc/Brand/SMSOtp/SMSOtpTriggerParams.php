 ...
 *
 * @see Telnyx\Services\Number10dlc\Brand\SMSOtpService::trigger()
 *
 * @phpstan-type SMSOtpTriggerParamsShape = array{
 *   pinSMS: string, successSMS: string
 * }
 */
final class SMSOtpTriggerParams implements BaseModel
{
    /** @use SdkModel<SMSOtpTriggerParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new SMSOtpTriggerParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SMSOtpTriggerParams::with(pinSMS: ..., successSMS: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new SMSOtpTriggerParams)->withPinSMS(...)->withSuccessSMS(...)
     * ```
     */
