 ...
 *
 * @see Telnyx\Services\Number10dlc\Brand\SMSOtpService::getStatus()
 *
 * @phpstan-type SMSOtpGetStatusParamsShape = array{brandID?: string}
 */
final class SMSOtpGetStatusParams implements BaseModel
{
    /** @use SdkModel<SMSOtpGetStatusParamsShape> */
    use SdkModel;
    use SdkParams;
