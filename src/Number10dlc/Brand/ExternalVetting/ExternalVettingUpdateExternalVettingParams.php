 ...
 *
 * @see Telnyx\Services\Number10dlc\Brand\ExternalVettingService::updateExternalVetting()
 *
 * @phpstan-type ExternalVettingUpdateExternalVettingParamsShape = array{
 *   evpID: string, vettingID: string, vettingToken?: string
 * }
 */
final class ExternalVettingUpdateExternalVettingParams implements BaseModel
{
    /** @use SdkModel<ExternalVettingUpdateExternalVettingParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new ExternalVettingUpdateExternalVettingParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ExternalVettingUpdateExternalVettingParams::with(evpID: ..., vettingID: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ExternalVettingUpdateExternalVettingParams)
     *   ->withEvpID(...)
     *   ->withVettingID(...)
     * ```
     */
