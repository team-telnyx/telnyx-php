...
/**
 * @phpstan-type ExternalVettingUpdateExternalVettingResponseShape = array{
 ...
 * }
 */
final class ExternalVettingUpdateExternalVettingResponse implements BaseModel
{
    /** @use SdkModel<ExternalVettingUpdateExternalVettingResponseShape> */
    use SdkModel;
