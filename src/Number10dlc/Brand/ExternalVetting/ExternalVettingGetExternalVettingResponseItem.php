...
/**
 * @phpstan-type ExternalVettingGetExternalVettingResponseItemShape = array{
 ...
 * }
 */
final class ExternalVettingGetExternalVettingResponseItem implements BaseModel
{
    /** @use SdkModel<ExternalVettingGetExternalVettingResponseItemShape> */
    use SdkModel;
