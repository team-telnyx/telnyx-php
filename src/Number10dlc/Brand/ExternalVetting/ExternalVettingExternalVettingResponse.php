...
/**
 * @phpstan-type ExternalVettingExternalVettingResponseShape = array{
 ...
 * }
 */
final class ExternalVettingExternalVettingResponse implements BaseModel
{
    /** @use SdkModel<ExternalVettingExternalVettingResponseShape> */
    use SdkModel;
