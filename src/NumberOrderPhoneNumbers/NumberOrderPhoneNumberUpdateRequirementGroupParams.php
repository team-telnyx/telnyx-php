 ...
 * Example usage:
 * ```
 * $params = (new NumberOrderPhoneNumberUpdateRequirementGroupParams); // set properties as needed
 * $client->numberOrderPhoneNumbers->updateRequirementGroup(...$params->toArray());
 * ```
