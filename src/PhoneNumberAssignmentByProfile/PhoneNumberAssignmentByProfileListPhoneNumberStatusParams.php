 ...
 *
 * @see Telnyx\Services\PhoneNumberAssignmentByProfileService::listPhoneNumberStatus()
 *
...
{
    /** @use SdkModel<PhoneNumberAssignmentByProfileListPhoneNumberStatusParamsShape> */
    use SdkModel;
    use SdkParams;
