 ...
 *
 * @phpstan-type ConferenceParticipantResourceShape = array{
 *   data?: null|ConferenceParticipant|ConferenceParticipantShape
 * }
 */
final class ConferenceParticipantResource implements BaseModel
{
    /** @use SdkModel<ConferenceParticipantResourceShape> */
    use SdkModel;
