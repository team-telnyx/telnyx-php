...
use Telnyx\Conferences\ConferenceParticipant\Status;
use Telnyx\Core\Attributes\Optional;
use Telnyx\Core\Concerns\SdkModel;
use Telnyx\Core\Contracts\BaseModel;

/**
 * @phpstan-type ConferenceParticipantShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class ConferenceParticipant implements BaseModel
{
    /** @use SdkModel<ConferenceParticipantShape> */
    use SdkModel;
