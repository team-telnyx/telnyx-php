 ...
 *
 * @see Telnyx\Services\SpeechToTextService::retrieveTranscription()
 *
 * @phpstan-type SpeechToTextRetrieveTranscriptionParamsShape = array{
...
{
    /** @use SdkModel<SpeechToTextRetrieveTranscriptionParamsShape> */
    use SdkModel;
    use SdkParams;
     ...
     * ```
     * SpeechToTextRetrieveTranscriptionParams::with(
     *   inputFormat: ..., transcriptionEngine: ...
     * )
     * ```
     *
     ...
     *
     * ```
     * (new SpeechToTextRetrieveTranscriptionParams)
     *   ->withInputFormat(...)
