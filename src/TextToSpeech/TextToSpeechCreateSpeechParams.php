 ...
 *
 * @see Telnyx\Services\TextToSpeechService::createSpeech()
 *
 ...
 *
 * @phpstan-type TextToSpeechCreateSpeechParamsShape = array{
 ...
 * }
 */
final class TextToSpeechCreateSpeechParams implements BaseModel
{
    /** @use SdkModel<TextToSpeechCreateSpeechParamsShape> */
    use SdkModel;
    use SdkParams;
