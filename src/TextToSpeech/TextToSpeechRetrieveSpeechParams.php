 ...
 *
 * @see Telnyx\Services\TextToSpeechService::retrieveSpeech()
 *
 * @phpstan-type TextToSpeechRetrieveSpeechParamsShape = array{
 ...
 * }
 */
final class TextToSpeechRetrieveSpeechParams implements BaseModel
{
    /** @use SdkModel<TextToSpeechRetrieveSpeechParamsShape> */
    use SdkModel;
    use SdkParams;
