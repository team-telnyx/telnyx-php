 ...
 *
 * @phpstan-type TextToSpeechGenerateSpeechResponseShape = array{
 *   base64Audio?: string|null
 * }
 */
final class TextToSpeechGenerateSpeechResponse implements BaseModel
{
    /** @use SdkModel<TextToSpeechGenerateSpeechResponseShape> */
    use SdkModel;
