 ...
 *
 * @phpstan-type TextToSpeechNewSpeechResponseShape = array{
 *   base64Audio?: string|null
 * }
 */
final class TextToSpeechNewSpeechResponse implements BaseModel
{
    /** @use SdkModel<TextToSpeechNewSpeechResponseShape> */
    use SdkModel;
