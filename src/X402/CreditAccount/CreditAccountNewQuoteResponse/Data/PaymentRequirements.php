...
namespace Telnyx\X402\CreditAccount\CreditAccountNewQuoteResponse\Data;

use Telnyx\Core\Attributes\Optional;
use Telnyx\Core\Concerns\SdkModel;
use Telnyx\Core\Contracts\BaseModel;
use Telnyx\X402\CreditAccount\CreditAccountNewQuoteResponse\Data\PaymentRequirements\Accept;
use Telnyx\X402\CreditAccount\CreditAccountNewQuoteResponse\Data\PaymentRequirements\Resource;
use Telnyx\X402\CreditAccount\CreditAccountNewQuoteResponse\Data\PaymentRequirements\X402Version;

/**
 * x402 protocol v2 payment requirements. Contains all information needed to construct and sign a payment authorization.
 *
 * @phpstan-import-type AcceptShape from \Telnyx\X402\CreditAccount\CreditAccountNewQuoteResponse\Data\PaymentRequirements\Accept
 * @phpstan-import-type ResourceShape from \Telnyx\X402\CreditAccount\CreditAccountNewQuoteResponse\Data\PaymentRequirements\Resource
 *
