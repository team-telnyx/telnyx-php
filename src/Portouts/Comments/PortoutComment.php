...
/**
 * @phpstan-type PortoutCommentShape = array{
 *   id: string,
 *   body: string,
 *   createdAt: string,
 *   userID: string,
 ...
 * }
 */
final class PortoutComment implements BaseModel
{
    /** @use SdkModel<PortoutCommentShape> */
    use SdkModel;
    ...
    /**
     * `new PortoutComment()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * PortoutComment::with(id: ..., body: ..., createdAt: ..., userID: ...)
     * ```
     *
