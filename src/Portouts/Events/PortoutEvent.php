 ...
 *
 * @phpstan-type PortoutEventVariants = WebhookPortoutStatusChanged|WebhookPortoutNewComment|WebhookPortoutFocDateChanged
 * @phpstan-type PortoutEventShape = PortoutEventVariants|WebhookPortoutStatusChangedShape|WebhookPortoutNewCommentShape|WebhookPortoutFocDateChangedShape
 */
final class PortoutEvent implements ConverterSource
{
    use SdkUnion;
