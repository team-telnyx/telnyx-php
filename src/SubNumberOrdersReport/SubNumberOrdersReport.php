...
use Telnyx\SubNumberOrdersReport\SubNumberOrdersReport\Filters;
use Telnyx\SubNumberOrdersReport\SubNumberOrdersReport\Status;

/**
 * @phpstan-import-type FiltersShape from \Telnyx\SubNumberOrdersReport\SubNumberOrdersReport\Filters
 *
 * @phpstan-type SubNumberOrdersReportShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class SubNumberOrdersReport implements BaseModel
{
    /** @use SdkModel<SubNumberOrdersReportShape> */
    use SdkModel;
