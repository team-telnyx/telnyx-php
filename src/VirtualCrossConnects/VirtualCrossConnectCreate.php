...
use Telnyx\VirtualCrossConnects\VirtualCrossConnectCreate\CloudProvider;

/**
 * @phpstan-type VirtualCrossConnectCreateShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class VirtualCrossConnectCreate implements BaseModel
{
    /** @use SdkModel<VirtualCrossConnectCreateShape> */
    use SdkModel;
    ...
    /**
     * `new VirtualCrossConnectCreate()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * VirtualCrossConnectCreate::with(regionCode: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new VirtualCrossConnectCreate)->withRegionCode(...)
     * ```
     */
