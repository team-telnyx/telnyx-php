...
final class VirtualCrossConnectListResponse implements BaseModel
{
    ...
    /**
     * `new VirtualCrossConnectListResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * VirtualCrossConnectListResponse::with(regionCode: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new VirtualCrossConnectListResponse)->withRegionCode(...)
     * ```
     */
