...
use Telnyx\EmailBracketCursorPagination\Meta;

/**
 * @phpstan-type EmailBracketCursorPaginationShape = array{
 ...
 */
final class EmailBracketCursorPagination implements BaseModel, BasePage
{
    /** @use SdkModel<EmailBracketCursorPaginationShape> */
    use SdkModel;
    ...
    public function nextRequest(): ?array
    {
        ...
        if (!($next = $this->meta->pageCursor ?? null)) {
            return null;
        }
