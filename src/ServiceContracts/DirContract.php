...
interface DirContract
{
     ...
     * @param list<\Telnyx\Dir\DirUpdateInfringementParams\Document|DocumentShape1>|null $documents Append-only supporting documents to attach while resolving the claim (e.g. authorization or licensing proof).
