 ...
 * }
 */
final class TelcoDataUsageReportResponse implements BaseModel
{
    /** @use SdkModel<TelcoDataUsageReportResponseShape> */
    use SdkModel;
     ...
     *
     * @var list<TelcoDataUsageRecord>|null $result
     */
    #[Optional(list: TelcoDataUsageRecord::class)]
    public ?array $result;
