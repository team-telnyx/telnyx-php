...
use Telnyx\Enterprises\Dir\DirListResponse\CallReason;
use Telnyx\Enterprises\Dir\DirListResponse\Document;
use Telnyx\Enterprises\Dir\DirListResponse\RejectionReason;
use Telnyx\Enterprises\Dir\DirListResponse\Status;

/**
 * @phpstan-import-type CallReasonShape from \Telnyx\Enterprises\Dir\DirListResponse\CallReason
 * @phpstan-import-type DocumentShape from \Telnyx\Enterprises\Dir\DirListResponse\Document
 * @phpstan-import-type RejectionReasonShape from \Telnyx\Enterprises\Dir\DirListResponse\RejectionReason
 *
 * @phpstan-type DirListResponseShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class DirListResponse implements BaseModel
{
    /** @use SdkModel<DirListResponseShape> */
    use SdkModel;
