 ...
 *
 * @phpstan-type EnterpriseReputationPublicWrappedShape = array{
 *   data: EnterpriseReputationPublic|EnterpriseReputationPublicShape
 * }
 */
final class EnterpriseReputationPublicWrapped implements BaseModel
{
    /** @use SdkModel<EnterpriseReputationPublicWrappedShape> */
    use SdkModel;
    ...
    /**
     * `new EnterpriseReputationPublicWrapped()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * EnterpriseReputationPublicWrapped::with(data: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new EnterpriseReputationPublicWrapped)->withData(...)
     * ```
     */
