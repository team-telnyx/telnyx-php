 ...
 *
 * @phpstan-type ReputationPhoneNumberListWithReputationShape = array{
 ...
 * }
 */
final class ReputationPhoneNumberListWithReputation implements BaseModel
{
    /** @use SdkModel<ReputationPhoneNumberListWithReputationShape> */
    use SdkModel;
    ...
    /**
     * `new ReputationPhoneNumberListWithReputation()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * ReputationPhoneNumberListWithReputation::with(data: ..., meta: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new ReputationPhoneNumberListWithReputation)->withData(...)->withMeta(...)
     * ```
     */
