 ...
 *
 * @phpstan-import-type RemediationPerNumberResultsShape from \Telnyx\Enterprises\Reputation\Remediation\RemediationPerNumberResults
 *
 * @phpstan-type RemediationRequestShape = array{
 *   id: string,
 *   callPurpose: string,
 ...
 *   results?: null|RemediationPerNumberResults|RemediationPerNumberResultsShape,
 *   tier1CompletedAt?: \DateTimeInterface|null,
 *   tier2CompletedAt?: \DateTimeInterface|null,
 *   webhookURL?: string|null,
 * }
 */
final class RemediationRequest implements BaseModel
{
    /** @use SdkModel<RemediationRequestShape> */
    use SdkModel;
    ...
    /**
     * `new RemediationRequest()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * RemediationRequest::with(
     *   id: ...,
     *   callPurpose: ...,
     *   createdAt: ...,
     *   phoneNumbersCount: ...,
    ...
    public function withResults(
        RemediationPerNumberResults|array|null $results
    ): self {
        $self = clone $this;
