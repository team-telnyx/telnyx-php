 ...
 *
 * @phpstan-type RemediationPerNumberResultsShape = array{
 ...
 * }
 */
final class RemediationPerNumberResults implements BaseModel
{
    /** @use SdkModel<RemediationPerNumberResultsShape> */
    use SdkModel;
