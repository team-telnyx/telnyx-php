...
use Telnyx\Enterprises\Reputation\EnterpriseReputationPublic;

/**
 * @phpstan-import-type EnterpriseReputationPublicShape from \Telnyx\Enterprises\Reputation\EnterpriseReputationPublic
 *
 * @phpstan-type LoaUpdateResponseShape = array{
 *   data: EnterpriseReputationPublic|EnterpriseReputationPublicShape
 * }
 */
final class LoaUpdateResponse implements BaseModel
{
    /** @use SdkModel<LoaUpdateResponseShape> */
    use SdkModel;
    ...
    /**
     * `new LoaUpdateResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * LoaUpdateResponse::with(data: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new LoaUpdateResponse)->withData(...)
     * ```
     */
