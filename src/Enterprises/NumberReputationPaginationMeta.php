 ...
 *
 * @phpstan-type NumberReputationPaginationMetaShape = array{
 *   pageNumber: int, pageSize: int, totalPages: int, totalResults: int
 * }
 */
final class NumberReputationPaginationMeta implements BaseModel
{
    /** @use SdkModel<NumberReputationPaginationMetaShape> */
    use SdkModel;
    ...
    /**
     * `new NumberReputationPaginationMeta()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * NumberReputationPaginationMeta::with(
     ...
     *
     * ```
     * (new NumberReputationPaginationMeta)
     *   ->withPageNumber(...)
     *   ->withPageSize(...)
     *   ->withTotalPages(...)
     *   ->withTotalResults(...)
