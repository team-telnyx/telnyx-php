...
/**
 * @phpstan-import-type LocalShape from \Telnyx\CountryCoverage\CountryCoverage\Local
 * @phpstan-import-type TollFreeShape from \Telnyx\CountryCoverage\CountryCoverage\TollFree
 *
 * @phpstan-type CountryCoverageShape = array{
 *   code?: string|null,
 ...
 * }
 */
final class CountryCoverage implements BaseModel
{
    /** @use SdkModel<CountryCoverageShape> */
    use SdkModel;
