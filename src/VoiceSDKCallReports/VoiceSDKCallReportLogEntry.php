...
use Telnyx\VoiceSDKCallReports\VoiceSDKCallReportLogEntry\Level;

/**
 * A raw Voice SDK log entry. Additional SDK-specific fields may be present.
 *
 * @phpstan-type VoiceSDKCallReportLogEntryShape = array{
 ...
 * }
 */
final class VoiceSDKCallReportLogEntry implements BaseModel
{
    /** @use SdkModel<VoiceSDKCallReportLogEntryShape> */
    use SdkModel;
