...
use Telnyx\EmailCursorPagination\Meta;

/**
 * @phpstan-type EmailCursorPaginationShape = array{
 ...
 */
final class EmailCursorPagination implements BaseModel, BasePage
{
    /** @use SdkModel<EmailCursorPaginationShape> */
    use SdkModel;
