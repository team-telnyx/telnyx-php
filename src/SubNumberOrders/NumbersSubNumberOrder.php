...
use Telnyx\SubNumberOrders\NumbersSubNumberOrder\PhoneNumber;
use Telnyx\SubNumberOrders\NumbersSubNumberOrder\PhoneNumberType;
use Telnyx\SubNumberOrders\NumbersSubNumberOrder\Status;

/**
 * @phpstan-import-type PhoneNumberShape from \Telnyx\SubNumberOrders\NumbersSubNumberOrder\PhoneNumber
 ...
 *
 * @phpstan-type NumbersSubNumberOrderShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class NumbersSubNumberOrder implements BaseModel
{
    /** @use SdkModel<NumbersSubNumberOrderShape> */
    use SdkModel;
    ...
    /**
     * The first 50 phone numbers in the sub number order, including their per-number regulatory requirement statuses. Only present when filter[include_phone_numbers]=true is used.
     *
