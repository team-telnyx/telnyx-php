...
use Telnyx\Payment\AutoRechargePrefs\AutoRechargePref\Preference;

/**
 * @phpstan-type AutoRechargePrefShape = array{
 *   id?: string|null,
 *   enabled?: bool|null,
 ...
 * }
 */
final class AutoRechargePref implements BaseModel
{
    /** @use SdkModel<AutoRechargePrefShape> */
    use SdkModel;
