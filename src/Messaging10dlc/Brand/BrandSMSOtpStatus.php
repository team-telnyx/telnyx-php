 ...
 *
 * @phpstan-type BrandSMSOtpStatusShape = array{
 *   brandID: string,
 ...
 * }
 */
final class BrandSMSOtpStatus implements BaseModel
{
    /** @use SdkModel<BrandSMSOtpStatusShape> */
    use SdkModel;
    ...
    /**
     * `new BrandSMSOtpStatus()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BrandSMSOtpStatus::with(
     *   brandID: ...,
     *   deliveryStatus: ...,
     *   mobilePhone: ...,
     *   referenceID: ...,
