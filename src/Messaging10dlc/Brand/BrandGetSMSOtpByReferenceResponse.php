 ...
 *
 * @phpstan-type BrandGetSMSOtpByReferenceResponseShape = array{
 *   brandID: string,
 ...
 * }
 */
final class BrandGetSMSOtpByReferenceResponse implements BaseModel
{
    /** @use SdkModel<BrandGetSMSOtpByReferenceResponseShape> */
    use SdkModel;
    ...
    /**
     * `new BrandGetSMSOtpByReferenceResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BrandGetSMSOtpByReferenceResponse::with(
     *   brandID: ...,
     *   deliveryStatus: ...,
     *   mobilePhone: ...,
     *   referenceID: ...,
     ...
     *
     * ```
     * (new BrandGetSMSOtpByReferenceResponse)
     *   ->withBrandID(...)
     *   ->withDeliveryStatus(...)
     *   ->withMobilePhone(...)
     *   ->withReferenceID(...)
