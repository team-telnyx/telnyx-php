 ...
 *
 * @phpstan-type BrandGetSMSOtpStatusResponseShape = array{
 *   brandID: string,
 ...
 * }
 */
final class BrandGetSMSOtpStatusResponse implements BaseModel
{
    /** @use SdkModel<BrandGetSMSOtpStatusResponseShape> */
    use SdkModel;
    ...
    /**
     * `new BrandGetSMSOtpStatusResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BrandGetSMSOtpStatusResponse::with(
     *   brandID: ...,
     *   deliveryStatus: ...,
     *   mobilePhone: ...,
     *   referenceID: ...,
     ...
     *
     * ```
     * (new BrandGetSMSOtpStatusResponse)
     *   ->withBrandID(...)
     *   ->withDeliveryStatus(...)
     *   ->withMobilePhone(...)
     *   ->withReferenceID(...)
