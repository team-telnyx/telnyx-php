...
/**
 * @phpstan-type ExternalVettingOrderResponseShape = array{
 ...
 * }
 */
final class ExternalVettingOrderResponse implements BaseModel
{
    /** @use SdkModel<ExternalVettingOrderResponseShape> */
    use SdkModel;
