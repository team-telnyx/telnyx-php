...
namespace Telnyx\Messaging10dlc\Brand\ExternalVetting;
...
/**
 * @phpstan-type ExternalVettingImportsResponseShape = array{
 ...
 * }
 */
final class ExternalVettingImportsResponse implements BaseModel
{
    /** @use SdkModel<ExternalVettingImportsResponseShape> */
    use SdkModel;
