...
/**
 * @phpstan-type number_order_update_response = array{
 *   data?: NumberOrderWithPhoneNumbers
 * }
 */
final class NumberOrderUpdateResponse implements BaseModel, ResponseConverter
{
    /** @use SdkModel<number_order_update_response> */
    use SdkModel;
