...
/**
 * @phpstan-type number_reservation_list_response = array{
 *   data?: list<NumberReservation>, meta?: PaginationMeta
 * }
...
{
    /** @use SdkModel<number_reservation_list_response> */
    use SdkModel;
     ...
     *
     * @param list<NumberReservation> $data
     */
