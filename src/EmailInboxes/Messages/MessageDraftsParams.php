 ...
 *
 * @see Telnyx\Services\EmailInboxes\MessagesService::drafts()
 *
 ...
 *
 * @phpstan-type MessageDraftsParamsShape = array{
 *   inboxID: string,
 ...
 * }
 */
final class MessageDraftsParams implements BaseModel
{
    /** @use SdkModel<MessageDraftsParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new MessageDraftsParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * MessageDraftsParams::with(inboxID: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new MessageDraftsParams)->withInboxID(...)
     * ```
     */
