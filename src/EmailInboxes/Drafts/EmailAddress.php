...
/**
 * @phpstan-type EmailAddressShape = array{email: string, name?: string|null}
 */
final class EmailAddress implements BaseModel
{
    ...
    /**
     * `new EmailAddress()` is missing required properties by the API.
     *
