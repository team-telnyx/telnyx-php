 ...
 *
 * @phpstan-type ThreadMessageShape = array{
 *   id: string,
 ...
 * }
 */
final class ThreadMessage implements BaseModel
{
    /** @use SdkModel<ThreadMessageShape> */
    use SdkModel;
    ...
    /**
     * `new ThreadMessage()` is missing required properties by the API.
     *
