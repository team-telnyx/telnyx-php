...
/**
 * @phpstan-type InboundThreadShape = array{
 *   id: string,
 ...
 * }
 */
final class InboundThread implements BaseModel
{
    /** @use SdkModel<InboundThreadShape> */
    use SdkModel;
    ...
    /**
     * `new InboundThread()` is missing required properties by the API.
     *
