...
use Telnyx\PhoneNumbers\NumbersPhoneNumberDetailed\SourceType;
use Telnyx\PhoneNumbers\NumbersPhoneNumberDetailed\Status;

/**
 * @phpstan-type NumbersPhoneNumberDetailedShape = array{
 *   id: string,
 ...
 * }
 */
final class NumbersPhoneNumberDetailed implements BaseModel
{
    /** @use SdkModel<NumbersPhoneNumberDetailedShape> */
    use SdkModel;
    ...
    /**
     * `new NumbersPhoneNumberDetailed()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * NumbersPhoneNumberDetailed::with(
     *   id: ...,
     *   countryISOAlpha2: ...,
     *   createdAt: ...,
     *   deletionLockEnabled: ...,
     ...
     *
     * ```
     * (new NumbersPhoneNumberDetailed)
     *   ->withID(...)
