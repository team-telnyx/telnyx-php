...
/**
 * @phpstan-type VoicemailNewResponseShape = array{data?: VoicemailPrefResponse}
 */
final class VoicemailNewResponse implements BaseModel, ResponseConverter
{
    /** @use SdkModel<VoicemailNewResponseShape> */
    use SdkModel;
