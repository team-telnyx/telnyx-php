...
use Telnyx\Compute\Funcs\FuncGetLogsResponse\FuncInvocationLogsResponse\Data;
...
/**
 * @phpstan-import-type DataShape from \Telnyx\Compute\Funcs\FuncGetLogsResponse\FuncInvocationLogsResponse\Data
 * @phpstan-import-type LogsMetaShape from \Telnyx\Compute\Funcs\LogsMeta
 *
 * @phpstan-type FuncInvocationLogsResponseShape = array{
 *   data?: list<Data|DataShape>|null, meta?: null|LogsMeta|LogsMetaShape
 * }
 */
final class FuncInvocationLogsResponse implements BaseModel
{
    /** @use SdkModel<FuncInvocationLogsResponseShape> */
    use SdkModel;
