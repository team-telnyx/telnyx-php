...
use Telnyx\Compute\Funcs\FuncGetMetricAggregatesResponse\Data;
use Telnyx\Core\Attributes\Optional;
use Telnyx\Core\Concerns\SdkModel;
use Telnyx\Core\Contracts\BaseModel;

/**
 * @phpstan-import-type DataShape from \Telnyx\Compute\Funcs\FuncGetMetricAggregatesResponse\Data
 ...
 *
 * @phpstan-type FuncGetMetricAggregatesResponseShape = array{
 *   data?: list<Data|DataShape>|null,
 *   meta?: null|FunctionsObservabilityPaginationMeta|FunctionsObservabilityPaginationMetaShape,
 * }
 */
final class FuncGetMetricAggregatesResponse implements BaseModel
{
    /** @use SdkModel<FuncGetMetricAggregatesResponseShape> */
    use SdkModel;
