...
/**
 * @phpstan-type SuppressedRecipientShape = array{
 *   overrideAllowed: bool, reason: string, scope: string, to: string
 * }
 */
final class SuppressedRecipient implements BaseModel
{
    /** @use SdkModel<SuppressedRecipientShape> */
    use SdkModel;
    ...
    /**
     * `new SuppressedRecipient()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * SuppressedRecipient::with(
     *   overrideAllowed: ..., reason: ..., scope: ..., to: ...
     * )
     * ```
     *
