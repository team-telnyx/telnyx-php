...
use Telnyx\Queues\Calls\QueueCall\RecordType;

/**
 * @phpstan-type QueueCallShape = array{
 ...
 * }
 */
final class QueueCall implements BaseModel
{
    /** @use SdkModel<QueueCallShape> */
    use SdkModel;
    ...
    /**
     * `new QueueCall()` is missing required properties by the API.
     *
