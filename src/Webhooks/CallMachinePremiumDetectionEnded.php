...
use Telnyx\Webhooks\CallMachinePremiumDetectionEnded\EventType;
use Telnyx\Webhooks\CallMachinePremiumDetectionEnded\Payload;
use Telnyx\Webhooks\CallMachinePremiumDetectionEnded\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallMachinePremiumDetectionEnded\Payload
 *
 * @phpstan-type CallMachinePremiumDetectionEndedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallMachinePremiumDetectionEnded implements BaseModel
{
    /** @use SdkModel<CallMachinePremiumDetectionEndedShape> */
    use SdkModel;
