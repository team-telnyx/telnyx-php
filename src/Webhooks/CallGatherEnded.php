...
use Telnyx\Webhooks\CallGatherEnded\EventType;
use Telnyx\Webhooks\CallGatherEnded\Payload;
use Telnyx\Webhooks\CallGatherEnded\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallGatherEnded\Payload
 *
 * @phpstan-type CallGatherEndedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallGatherEnded implements BaseModel
{
    /** @use SdkModel<CallGatherEndedShape> */
    use SdkModel;
