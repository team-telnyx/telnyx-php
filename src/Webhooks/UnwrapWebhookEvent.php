...
final class UnwrapWebhookEvent implements ConverterSource
{
    ...
    {
        return [
            CallAIGatherEnded::class,
            CallAIGatherMessageHistoryUpdated::class,
