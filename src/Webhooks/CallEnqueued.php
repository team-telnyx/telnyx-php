...
use Telnyx\Webhooks\CallEnqueued\EventType;
use Telnyx\Webhooks\CallEnqueued\Payload;
use Telnyx\Webhooks\CallEnqueued\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallEnqueued\Payload
 *
 * @phpstan-type CallEnqueuedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallEnqueued implements BaseModel
{
    /** @use SdkModel<CallEnqueuedShape> */
    use SdkModel;
