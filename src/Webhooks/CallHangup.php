...
use Telnyx\Webhooks\CallHangup\EventType;
use Telnyx\Webhooks\CallHangup\Payload;
use Telnyx\Webhooks\CallHangup\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallHangup\Payload
 *
 * @phpstan-type CallHangupShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallHangup implements BaseModel
{
    /** @use SdkModel<CallHangupShape> */
    use SdkModel;
