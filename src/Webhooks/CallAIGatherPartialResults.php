...
use Telnyx\Webhooks\CallAIGatherPartialResults\EventType;
use Telnyx\Webhooks\CallAIGatherPartialResults\Payload;
use Telnyx\Webhooks\CallAIGatherPartialResults\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallAIGatherPartialResults\Payload
 *
 * @phpstan-type CallAIGatherPartialResultsShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallAIGatherPartialResults implements BaseModel
{
    /** @use SdkModel<CallAIGatherPartialResultsShape> */
    use SdkModel;
