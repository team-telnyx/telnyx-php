...
use Telnyx\Webhooks\FaxFailedWebhookEvent\Payload1\Direction;
use Telnyx\Webhooks\FaxFailedWebhookEvent\Payload1\FailureReason;
use Telnyx\Webhooks\FaxFailedWebhookEvent\Payload1\Status;
...
final class Payload1 implements BaseModel
{
     ...
     */
    #[Api(enum: FailureReason::class, optional: true)]
