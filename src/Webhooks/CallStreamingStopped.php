...
/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallStreamingStopped\Payload
 *
 * @phpstan-type CallStreamingStoppedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallStreamingStopped implements BaseModel
{
    /** @use SdkModel<CallStreamingStoppedShape> */
    use SdkModel;
