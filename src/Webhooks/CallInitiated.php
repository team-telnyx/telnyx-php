...
use Telnyx\Webhooks\CallInitiated\EventType;
use Telnyx\Webhooks\CallInitiated\Payload;
use Telnyx\Webhooks\CallInitiated\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallInitiated\Payload
 *
 * @phpstan-type CallInitiatedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallInitiated implements BaseModel
{
    /** @use SdkModel<CallInitiatedShape> */
    use SdkModel;
