...
use Telnyx\Webhooks\CallAnswered\EventType;
use Telnyx\Webhooks\CallAnswered\Payload;
use Telnyx\Webhooks\CallAnswered\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallAnswered\Payload
 *
 * @phpstan-type CallAnsweredShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallAnswered implements BaseModel
{
    /** @use SdkModel<CallAnsweredShape> */
    use SdkModel;
