...
use Telnyx\Webhooks\CallBridged\EventType;
use Telnyx\Webhooks\CallBridged\Payload;
use Telnyx\Webhooks\CallBridged\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallBridged\Payload
 *
 * @phpstan-type CallBridgedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallBridged implements BaseModel
{
    /** @use SdkModel<CallBridgedShape> */
    use SdkModel;
