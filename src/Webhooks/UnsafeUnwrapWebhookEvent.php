 ...
 * @phpstan-import-type ArtifactCompletedWebhookEventShape from \Telnyx\Webhooks\ArtifactCompletedWebhookEvent
 * @phpstan-import-type ArtifactFailedWebhookEventShape from \Telnyx\Webhooks\ArtifactFailedWebhookEvent
 ...
 * @phpstan-import-type CallCostWebhookEventShape from \Telnyx\Webhooks\CallCostWebhookEvent
 * @phpstan-import-type CallDeepfakeDetectionErrorWebhookEventShape from \Telnyx\Webhooks\CallDeepfakeDetectionErrorWebhookEvent
 * @phpstan-import-type CallDeepfakeDetectionResultWebhookEventShape from \Telnyx\Webhooks\CallDeepfakeDetectionResultWebhookEvent
 ...
 * @phpstan-import-type CallHoldWebhookEventShape from \Telnyx\Webhooks\CallHoldWebhookEvent
 ...
 * @phpstan-import-type CallPaymentCompletedWebhookEventShape from \Telnyx\Webhooks\CallPaymentCompletedWebhookEvent
 * @phpstan-import-type CallPaymentProgressWebhookEventShape from \Telnyx\Webhooks\CallPaymentProgressWebhookEvent
 ...
 * @phpstan-import-type CallUnholdWebhookEventShape from \Telnyx\Webhooks\CallUnholdWebhookEvent
 ...
 * @phpstan-import-type HostedNumberOrderEventWebhookEventShape from \Telnyx\Webhooks\HostedNumberOrderEventWebhookEvent
...
final class UnsafeUnwrapWebhookEvent implements ConverterSource
{
    ...
    public static function variants(): array
    {
        return [
            ...
            ArtifactCompletedWebhookEvent::class,
            ArtifactFailedWebhookEvent::class,
            ...
            CallCostWebhookEvent::class,
            CallDeepfakeDetectionErrorWebhookEvent::class,
            CallDeepfakeDetectionResultWebhookEvent::class,
            ...
            CallPaymentCompletedWebhookEvent::class,
            CallPaymentProgressWebhookEvent::class,
            ...
            HostedNumberOrderEventWebhookEvent::class,
            InboundMessageWebhookEvent::class,
            NumberOrderStatusUpdateWebhookEvent::class,
            RecordingAvailableWebhookEvent::class,
            ReplacedLinkClickWebhookEvent::class,
            SessionStatusChangedWebhookEvent::class,
            TranscriptCompletedWebhookEvent::class,
            TranscriptionWebhookEvent::class,
            WhatsappAccountUpdate::class,
            WhatsappMessageEcho::class,
        ];
    }
}
