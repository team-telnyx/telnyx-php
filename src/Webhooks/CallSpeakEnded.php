...
use Telnyx\Webhooks\CallSpeakEnded\EventType;
use Telnyx\Webhooks\CallSpeakEnded\Payload;
use Telnyx\Webhooks\CallSpeakEnded\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallSpeakEnded\Payload
 *
 * @phpstan-type CallSpeakEndedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallSpeakEnded implements BaseModel
{
    /** @use SdkModel<CallSpeakEndedShape> */
    use SdkModel;
