...
use Telnyx\Webhooks\ConferenceParticipantJoined\EventType;
use Telnyx\Webhooks\ConferenceParticipantJoined\Payload;
use Telnyx\Webhooks\ConferenceParticipantJoined\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\ConferenceParticipantJoined\Payload
 *
 * @phpstan-type ConferenceParticipantJoinedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class ConferenceParticipantJoined implements BaseModel
{
    /** @use SdkModel<ConferenceParticipantJoinedShape> */
    use SdkModel;
