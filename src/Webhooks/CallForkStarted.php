...
use Telnyx\Webhooks\CallForkStarted\EventType;
use Telnyx\Webhooks\CallForkStarted\Payload;
use Telnyx\Webhooks\CallForkStarted\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallForkStarted\Payload
 *
 * @phpstan-type CallForkStartedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallForkStarted implements BaseModel
{
    /** @use SdkModel<CallForkStartedShape> */
    use SdkModel;
