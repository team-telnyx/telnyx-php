...
use Telnyx\Webhooks\ConferenceCreated\EventType;
use Telnyx\Webhooks\ConferenceCreated\Payload;
use Telnyx\Webhooks\ConferenceCreated\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\ConferenceCreated\Payload
 *
 * @phpstan-type ConferenceCreatedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class ConferenceCreated implements BaseModel
{
    /** @use SdkModel<ConferenceCreatedShape> */
    use SdkModel;
