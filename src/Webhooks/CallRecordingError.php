...
use Telnyx\Webhooks\CallRecordingError\EventType;
use Telnyx\Webhooks\CallRecordingError\Payload;
use Telnyx\Webhooks\CallRecordingError\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallRecordingError\Payload
 *
 * @phpstan-type CallRecordingErrorShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallRecordingError implements BaseModel
{
    /** @use SdkModel<CallRecordingErrorShape> */
    use SdkModel;
