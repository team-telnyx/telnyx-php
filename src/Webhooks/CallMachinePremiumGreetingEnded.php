...
use Telnyx\Webhooks\CallMachinePremiumGreetingEnded\EventType;
use Telnyx\Webhooks\CallMachinePremiumGreetingEnded\Payload;
use Telnyx\Webhooks\CallMachinePremiumGreetingEnded\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallMachinePremiumGreetingEnded\Payload
 *
 * @phpstan-type CallMachinePremiumGreetingEndedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallMachinePremiumGreetingEnded implements BaseModel
{
    /** @use SdkModel<CallMachinePremiumGreetingEndedShape> */
    use SdkModel;
