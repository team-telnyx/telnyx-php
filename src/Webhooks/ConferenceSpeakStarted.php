...
use Telnyx\Webhooks\ConferenceSpeakStarted\EventType;
use Telnyx\Webhooks\ConferenceSpeakStarted\Payload;
use Telnyx\Webhooks\ConferenceSpeakStarted\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\ConferenceSpeakStarted\Payload
 *
 * @phpstan-type ConferenceSpeakStartedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class ConferenceSpeakStarted implements BaseModel
{
    /** @use SdkModel<ConferenceSpeakStartedShape> */
    use SdkModel;
