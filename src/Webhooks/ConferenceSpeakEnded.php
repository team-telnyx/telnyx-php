...
use Telnyx\Webhooks\ConferenceSpeakEnded\EventType;
use Telnyx\Webhooks\ConferenceSpeakEnded\Payload;
use Telnyx\Webhooks\ConferenceSpeakEnded\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\ConferenceSpeakEnded\Payload
 *
 * @phpstan-type ConferenceSpeakEndedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class ConferenceSpeakEnded implements BaseModel
{
    /** @use SdkModel<ConferenceSpeakEndedShape> */
    use SdkModel;
