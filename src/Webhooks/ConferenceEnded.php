...
use Telnyx\Webhooks\ConferenceEnded\EventType;
use Telnyx\Webhooks\ConferenceEnded\Payload;
use Telnyx\Webhooks\ConferenceEnded\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\ConferenceEnded\Payload
 *
 * @phpstan-type ConferenceEndedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class ConferenceEnded implements BaseModel
{
    /** @use SdkModel<ConferenceEndedShape> */
    use SdkModel;
