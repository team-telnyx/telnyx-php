...
use Telnyx\Webhooks\CallForkStopped\EventType;
use Telnyx\Webhooks\CallForkStopped\Payload;
use Telnyx\Webhooks\CallForkStopped\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallForkStopped\Payload
 *
 * @phpstan-type CallForkStoppedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallForkStopped implements BaseModel
{
    /** @use SdkModel<CallForkStoppedShape> */
    use SdkModel;
