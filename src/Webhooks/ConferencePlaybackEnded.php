...
use Telnyx\Webhooks\ConferencePlaybackEnded\EventType;
use Telnyx\Webhooks\ConferencePlaybackEnded\Payload;
use Telnyx\Webhooks\ConferencePlaybackEnded\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\ConferencePlaybackEnded\Payload
 *
 * @phpstan-type ConferencePlaybackEndedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class ConferencePlaybackEnded implements BaseModel
{
    /** @use SdkModel<ConferencePlaybackEndedShape> */
    use SdkModel;
