...
use Telnyx\Webhooks\CallReferStarted\EventType;
use Telnyx\Webhooks\CallReferStarted\Payload;
use Telnyx\Webhooks\CallReferStarted\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallReferStarted\Payload
 *
 * @phpstan-type CallReferStartedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallReferStarted implements BaseModel
{
    /** @use SdkModel<CallReferStartedShape> */
    use SdkModel;
