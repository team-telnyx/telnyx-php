...
use Telnyx\Webhooks\CampaignStatusUpdate\Status;
use Telnyx\Webhooks\CampaignStatusUpdate\Type;

/**
 * @phpstan-type CampaignStatusUpdateShape = array{
 *   brandID?: string|null,
 ...
 * }
 */
final class CampaignStatusUpdate implements BaseModel
{
    /** @use SdkModel<CampaignStatusUpdateShape> */
    use SdkModel;
