...
use Telnyx\Webhooks\CallDtmfReceived\EventType;
use Telnyx\Webhooks\CallDtmfReceived\Payload;
use Telnyx\Webhooks\CallDtmfReceived\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallDtmfReceived\Payload
 *
 * @phpstan-type CallDtmfReceivedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallDtmfReceived implements BaseModel
{
    /** @use SdkModel<CallDtmfReceivedShape> */
    use SdkModel;
