...
use Telnyx\Webhooks\CallSpeakStarted\EventType;
use Telnyx\Webhooks\CallSpeakStarted\Payload;
use Telnyx\Webhooks\CallSpeakStarted\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallSpeakStarted\Payload
 *
 * @phpstan-type CallSpeakStartedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallSpeakStarted implements BaseModel
{
    /** @use SdkModel<CallSpeakStartedShape> */
    use SdkModel;
