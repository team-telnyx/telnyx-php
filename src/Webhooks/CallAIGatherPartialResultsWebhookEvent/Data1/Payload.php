...
use Telnyx\Webhooks\CallAIGatherPartialResultsWebhookEvent\Data1\Payload\MessageHistory\Role;
...
final class Payload implements BaseModel
{
    ...
    public static function with(
        ...
        null !== $partial_results && $obj['partial_results'] = $partial_results;
        null !== $to && $obj['to'] = $to;
    ...
    {
        $obj = clone $this;
        $obj['partial_results'] = $partialResults;
