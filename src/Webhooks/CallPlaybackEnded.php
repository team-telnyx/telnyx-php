...
use Telnyx\Webhooks\CallPlaybackEnded\EventType;
use Telnyx\Webhooks\CallPlaybackEnded\Payload;
use Telnyx\Webhooks\CallPlaybackEnded\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallPlaybackEnded\Payload
 *
 * @phpstan-type CallPlaybackEndedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallPlaybackEnded implements BaseModel
{
    /** @use SdkModel<CallPlaybackEndedShape> */
    use SdkModel;
