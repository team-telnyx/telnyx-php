...
use Telnyx\Webhooks\CallSiprecStopped\EventType;
use Telnyx\Webhooks\CallSiprecStopped\Payload;
use Telnyx\Webhooks\CallSiprecStopped\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallSiprecStopped\Payload
 *
 * @phpstan-type CallSiprecStoppedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallSiprecStopped implements BaseModel
{
    /** @use SdkModel<CallSiprecStoppedShape> */
    use SdkModel;
