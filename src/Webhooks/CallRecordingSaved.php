...
use Telnyx\Webhooks\CallRecordingSaved\EventType;
use Telnyx\Webhooks\CallRecordingSaved\Payload;
use Telnyx\Webhooks\CallRecordingSaved\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallRecordingSaved\Payload
 *
 * @phpstan-type CallRecordingSavedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallRecordingSaved implements BaseModel
{
    /** @use SdkModel<CallRecordingSavedShape> */
    use SdkModel;
