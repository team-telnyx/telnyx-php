...
use Telnyx\Webhooks\CallReferCompleted\EventType;
use Telnyx\Webhooks\CallReferCompleted\Payload;
use Telnyx\Webhooks\CallReferCompleted\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallReferCompleted\Payload
 *
 * @phpstan-type CallReferCompletedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallReferCompleted implements BaseModel
{
    /** @use SdkModel<CallReferCompletedShape> */
    use SdkModel;
