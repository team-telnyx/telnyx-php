...
use Telnyx\Webhooks\CallPlaybackStarted\EventType;
use Telnyx\Webhooks\CallPlaybackStarted\Payload;
use Telnyx\Webhooks\CallPlaybackStarted\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallPlaybackStarted\Payload
 *
 * @phpstan-type CallPlaybackStartedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallPlaybackStarted implements BaseModel
{
    /** @use SdkModel<CallPlaybackStartedShape> */
    use SdkModel;
