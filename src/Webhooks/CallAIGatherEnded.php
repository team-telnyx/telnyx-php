...
use Telnyx\Webhooks\CallAIGatherEnded\EventType;
use Telnyx\Webhooks\CallAIGatherEnded\Payload;
use Telnyx\Webhooks\CallAIGatherEnded\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallAIGatherEnded\Payload
 *
 * @phpstan-type CallAIGatherEndedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallAIGatherEnded implements BaseModel
{
    /** @use SdkModel<CallAIGatherEndedShape> */
    use SdkModel;
