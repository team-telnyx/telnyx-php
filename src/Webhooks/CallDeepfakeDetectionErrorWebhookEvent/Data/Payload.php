 ...
 *   errorMessage?: null|ErrorMessage|value-of<ErrorMessage>,
 * }
 */
final class Payload implements BaseModel
{
     ...
     *
     * @var value-of<ErrorMessage>|null $errorMessage
     */
    #[Optional('error_message', enum: ErrorMessage::class)]
     ...
     * The error that occurred. 'detection_timeout' = no DFD response received, 'rtp_timeout' = no RTP audio received, 'dfd_connection_error'/'dfd_stream_error' = service connectivity issues.
     *
     * @param ErrorMessage|value-of<ErrorMessage> $errorMessage
     */
    public function withErrorMessage(ErrorMessage|string $errorMessage): self
    {
        $self = clone $this;
