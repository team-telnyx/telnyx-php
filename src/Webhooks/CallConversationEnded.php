...
use Telnyx\Webhooks\CallConversationEnded\EventType;
use Telnyx\Webhooks\CallConversationEnded\Payload;
use Telnyx\Webhooks\CallConversationEnded\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallConversationEnded\Payload
 *
 * @phpstan-type CallConversationEndedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallConversationEnded implements BaseModel
{
    /** @use SdkModel<CallConversationEndedShape> */
    use SdkModel;
