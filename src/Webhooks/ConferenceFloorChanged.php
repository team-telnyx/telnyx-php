...
use Telnyx\Webhooks\ConferenceFloorChanged\EventType;
use Telnyx\Webhooks\ConferenceFloorChanged\Payload;
use Telnyx\Webhooks\ConferenceFloorChanged\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\ConferenceFloorChanged\Payload
 *
 * @phpstan-type ConferenceFloorChangedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class ConferenceFloorChanged implements BaseModel
{
    /** @use SdkModel<ConferenceFloorChangedShape> */
    use SdkModel;
