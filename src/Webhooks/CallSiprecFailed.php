...
use Telnyx\Webhooks\CallSiprecFailed\EventType;
use Telnyx\Webhooks\CallSiprecFailed\Payload;
use Telnyx\Webhooks\CallSiprecFailed\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallSiprecFailed\Payload
 *
 * @phpstan-type CallSiprecFailedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallSiprecFailed implements BaseModel
{
    /** @use SdkModel<CallSiprecFailedShape> */
    use SdkModel;
