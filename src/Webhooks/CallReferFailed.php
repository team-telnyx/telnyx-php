...
use Telnyx\Webhooks\CallReferFailed\EventType;
use Telnyx\Webhooks\CallReferFailed\Payload;
use Telnyx\Webhooks\CallReferFailed\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallReferFailed\Payload
 *
 * @phpstan-type CallReferFailedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallReferFailed implements BaseModel
{
    /** @use SdkModel<CallReferFailedShape> */
    use SdkModel;
