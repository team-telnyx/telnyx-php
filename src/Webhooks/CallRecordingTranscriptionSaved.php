...
use Telnyx\Webhooks\CallRecordingTranscriptionSaved\EventType;
use Telnyx\Webhooks\CallRecordingTranscriptionSaved\Payload;
use Telnyx\Webhooks\CallRecordingTranscriptionSaved\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallRecordingTranscriptionSaved\Payload
 *
 * @phpstan-type CallRecordingTranscriptionSavedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallRecordingTranscriptionSaved implements BaseModel
{
    /** @use SdkModel<CallRecordingTranscriptionSavedShape> */
    use SdkModel;
