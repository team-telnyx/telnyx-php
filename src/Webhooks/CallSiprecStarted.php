...
use Telnyx\Webhooks\CallSiprecStarted\EventType;
use Telnyx\Webhooks\CallSiprecStarted\Payload;
use Telnyx\Webhooks\CallSiprecStarted\RecordType;

/**
 * @phpstan-import-type PayloadShape from \Telnyx\Webhooks\CallSiprecStarted\Payload
 *
 * @phpstan-type CallSiprecStartedShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class CallSiprecStarted implements BaseModel
{
    /** @use SdkModel<CallSiprecStartedShape> */
    use SdkModel;
