 ...
 *
 * @phpstan-type CreateVerificationRequestSMSShape = array{
 *   phoneNumber: string,
 ...
 * }
 */
final class CreateVerificationRequestSMS implements BaseModel
{
    /** @use SdkModel<CreateVerificationRequestSMSShape> */
    use SdkModel;
    ...
    /**
     * `new CreateVerificationRequestSMS()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * CreateVerificationRequestSMS::with(phoneNumber: ..., verifyProfileID: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new CreateVerificationRequestSMS)
     *   ->withPhoneNumber(...)
     *   ->withVerifyProfileID(...)
     * ```
     */
