 ...
 *
 * @see Telnyx\Services\VerificationsService::triggerWhatsappVerification()
 *
 * @phpstan-type VerificationTriggerWhatsappVerificationParamsShape = array{
 *   phoneNumber: string,
 ...
 * }
 */
final class VerificationTriggerWhatsappVerificationParams implements BaseModel
{
    /** @use SdkModel<VerificationTriggerWhatsappVerificationParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new VerificationTriggerWhatsappVerificationParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * VerificationTriggerWhatsappVerificationParams::with(
     *   phoneNumber: ..., verifyProfileID: ...
     * )
     * ```
     *
     ...
     *
     * ```
     * (new VerificationTriggerWhatsappVerificationParams)
     *   ->withPhoneNumber(...)
     *   ->withVerifyProfileID(...)
     * ```
     */
