...
/**
 * @phpstan-type notification_channel_list_response = array{
 *   data?: list<NotificationChannel>, meta?: PaginationMeta
 * }
...
{
    /** @use SdkModel<notification_channel_list_response> */
    use SdkModel;
     ...
     *
     * @param list<NotificationChannel> $data
     */
