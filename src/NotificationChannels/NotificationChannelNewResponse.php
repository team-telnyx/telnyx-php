...
/**
 * @phpstan-type notification_channel_new_response = array{
 ...
 * @mixin TRawResponse
 */
final class NotificationChannelNewResponse implements BaseModel
{
    /** @use SdkModel<notification_channel_new_response> */
    use SdkModel;
