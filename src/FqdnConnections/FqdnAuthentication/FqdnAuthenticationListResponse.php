 ...
 *
 * @phpstan-type FqdnAuthenticationListResponseShape = array{
 *   data?: null|FqdnAuthentication|FqdnAuthenticationShape
 * }
 */
final class FqdnAuthenticationListResponse implements BaseModel
{
    /** @use SdkModel<FqdnAuthenticationListResponseShape> */
    use SdkModel;
