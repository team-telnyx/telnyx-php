 ...
 * Example usage:
 * ```
 * $params = (new OAuthExchangeTokenParams); // set properties as needed
 * $client->oauth->exchangeToken(...$params->toArray());
 * ```
 ...
 *   `$client->oauth->exchangeToken(...$params->toArray());`
 *
 * @see Telnyx\OAuth->exchangeToken
 *
 * @phpstan-type oauth_exchange_token_params = array{
 ...
 * }
 */
final class OAuthExchangeTokenParams implements BaseModel
{
    /** @use SdkModel<oauth_exchange_token_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new OAuthExchangeTokenParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * OAuthExchangeTokenParams::with(grantType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new OAuthExchangeTokenParams)->withGrantType(...)
     * ```
     */
