...
use Telnyx\OAuth\OAuthRegisterClientParams\GrantType;
 ...
 * Example usage:
 * ```
 * $params = (new OAuthRegisterClientParams); // set properties as needed
 * $client->oauth->registerClient(...$params->toArray());
 * ```
 ...
 *   `$client->oauth->registerClient(...$params->toArray());`
 *
 * @see Telnyx\OAuth->registerClient
 *
 * @phpstan-type oauth_register_client_params = array{
 *   clientName?: string,
 ...
 * }
 */
final class OAuthRegisterClientParams implements BaseModel
{
    /** @use SdkModel<oauth_register_client_params> */
    use SdkModel;
    use SdkParams;
