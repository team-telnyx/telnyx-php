...
/**
 * @phpstan-type oauth_register_client_response = array{
 *   clientID: string,
 ...
 * @mixin TRawResponse
 */
final class OAuthRegisterClientResponse implements BaseModel
{
    /** @use SdkModel<oauth_register_client_response> */
    use SdkModel;
    ...
    /**
     * `new OAuthRegisterClientResponse()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * OAuthRegisterClientResponse::with(clientID: ..., clientIDIssuedAt: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new OAuthRegisterClientResponse)->withClientID(...)->withClientIDIssuedAt(...)
     * ```
     */
