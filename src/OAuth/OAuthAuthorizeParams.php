 ...
 * Example usage:
 * ```
 * $params = (new OAuthAuthorizeParams); // set properties as needed
 * $client->oauth->authorize(...$params->toArray());
 * ```
 ...
 *   `$client->oauth->authorize(...$params->toArray());`
 *
 * @see Telnyx\OAuth->authorize
 *
 * @phpstan-type oauth_authorize_params = array{
 *   clientID: string,
 *   redirectUri: string,
 ...
 * }
 */
final class OAuthAuthorizeParams implements BaseModel
{
    /** @use SdkModel<oauth_authorize_params> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new OAuthAuthorizeParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * OAuthAuthorizeParams::with(clientID: ..., redirectUri: ..., responseType: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new OAuthAuthorizeParams)
     *   ->withClientID(...)
     *   ->withRedirectUri(...)
     *   ->withResponseType(...)
     * ```
